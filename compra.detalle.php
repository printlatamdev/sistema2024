              ...
              <div  id="contenedor3" class="portlet box blue">
                <div class="portlet-title">
                  <div class="caption">
                    ...
                    <a href="compra.editar.cabecera.php?compra=<?=$compra?>"><font color="white">Editar Cabecera</font></a>                  </div>
           ...
           <?
               ...
               if($rowcount<=0){ echo "<br><br><b>La orden de compra aun no contiene detalles.</b>";  }
                    ...
                    while ($fila_en = $cd->fetch_assoc()) { 
                     ...
                     $t_o=$t_o + $costo_total;
                     echo ' <tr><td align="center"><a class="delete" href="compra.sql.php?bandera=3&det='.$idc.'&compra='.$compra.'" ><img id="ex2" src="images/eli.png" alt="Eliminar Registro" /></a></td><td align="left">&nbsp;&nbsp;'.$mat.'</td><td align="center">'.$cat.'</td><td align="center">$'.$pre.'</td><td align="right"> $'.$costo_total.'&nbsp;</td></tr>';
