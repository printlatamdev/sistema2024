        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            ...
            <div class="portlet-body form">
              <form action="save.ventas.php" id="form-username" class="form-horizontal form-bordered" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <div class="input-group">
                      ...
                      <?  if (isset($_REQUEST['id2'])) { echo '<input size="15" autocomplete="off" type="text" class="form-control" name="fecha" value="'.$fecha.'" required readonly >';  }
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <div class="input-group">
                      ...
                      <?  if (isset($_REQUEST['id2'])) { echo '<input type="text"  name="cliente" class="form-control" required value="'.$cliente.'" readonly />';  }
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label"><b>Actividad:</b></label>
                  <div class="col-sm-4">
                    <div class="input-group">
                      

                        <?  if (isset($_REQUEST['id2'])) { echo '<textarea readonly name="nota" rows="4" cols="54" required>'.$nota.'</textarea>';  }
                          else{ echo '<textarea name="nota" rows="4" cols="54" required></textarea>'; } 
                      ?>
                ...
                <div class="form-group">
                <label class="col-sm-3 control-label"><b>Resultado:</b></label>
                  <div class="col-sm-4">
                    <div class="input-group">
                      

                    
                    <?  if (isset($_REQUEST['id2'])) { echo '<textarea name="resultado" rows="4" cols="54" >'.$resultado.'</textarea>';  }
                          else{ echo '<textarea name="resultado" rows="4" cols="54" ></textarea>'; } 
                      ?>

                      <?  if (isset($_REQUEST['id2'])) { echo '<input type="hidden" name="flag" value="1"> <input type="hidden" name="det" value="'.$_REQUEST['id2'].'">';  }
                          else{ echo '<input type="hidden" name="flag" value="0">'; } 
                      ?>
...
<!-- ------------CONTENIDO-----------------------------------------------------------------------------------------------  -->
                ...
                <? $id22=$_SESSION['id'];?>    <!-- BEGIN EXAMPLE TABLE PORTLET-->
          <div class="portlet box red-intense">
            <div class="portlet-title">
              <div class="caption"><i class="fa fa-edit"></i>Historial de Actividades<?echo $id22;?> - <?=$_SESSION['vsNombre']?>
              </div>
              <div class="tools"></div>
            </div>
           ...
           $sql="SELECT  * FROM log_ventas WHERE id_vendedor='".$id22."'";          
           $rs=$mysqli->query($sql);
           $p=0;
                     $i=0;
             while($row=$rs->fetch_assoc()){ 
                  ...
                  if($i==0){$class="odd"; $i=1;}
                     ...
                     echo "      
                        <tr class='".$class."' >
                        <td ><b>".$row['id_sales']."<b></td>
                        <td width='100px' ><center><font color='red'><b>".$row['fecha']."<b></font></center></td>
                        <td ><a target='_self' href='reporte.ventas.php?id2=".$row["id_sales"]."' ><font color='blue'><b>".strtoupper($row['cliente'])."<b></font></a></td>
