  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index.php" class="brand-link">
        <?php  if ($nivel != 50) { ?><img src="images/logo_color.png" alt="COLOR DIGITAL" style="opacity: .8" width="150"><?php  } ?>
        ...
        <div class="card-body">
          ...
          <div class="direct-chat-messages">
            ...
            <div class="card bg-gradient-success">
              <!-- Here You can ADD Special Content as a title -->
            </div><!-- /.card -->
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function handleFile(file) {
            if (!file || !file.name.match(/\.(xlsx|xls)$/)) {
                message.textContent = 'Por favor, sube un archivo de Excel válido.';
                return;
            }
            ...
            .then(data => {
                ...
                message.textContent = data.message || 'Datos procesados exitosamente.';
            })
            .catch(error => {
        ...
        function displayExcelData(data) {
            excelData.innerHTML = ''; // Clear previous content
