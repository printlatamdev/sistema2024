...
<br><br><br>
  <div class="row">
    <div class="col-md-1"></div>
        <a target="_self"  href="suministros.reporte.tintas.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            ...
            <a target="_self" class="more" href="suministros.reporte.tintas.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
        </a>
        <a target="_self"  href="suministros_materiales_lineales.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            <div class="visual">
            ...
            <a target="_self" class="more" href="suministros_materiales_lineales.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
        </a>
        <a target="_self"  href="suministros_materiales_rigidos.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            <div class="visual">
            ...
            <a target="_self" class="more" href="suministros_materiales_rigidos.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
  ...
  <div class="row">
    <div class="col-md-1"></div>
        <a target="_self"  href="suministros_materiales_display.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            <div class="visual">
            ...
            <a target="_self" class="more" href="suministros_materiales_display.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
        </a>
        <a target="_self"  href="suministros_materiales_accesorios.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            <div class="visual">
            ...
            <a target="_self" class="more" href="suministros_materiales_accesorios.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
        </a>
        <a target="_self"  href="suministros_materiales_telas.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            <div class="visual">
            ...
            <a target="_self" class="more" href="suministros_materiales_telas.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
       ...
       <div class="row"><div class="col-md-1"></div>
        <a target="_self"  href="suministros_materiales_repuestos.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            <div class="visual">
            ...
            <a target="_self" class="more" href="suministros_materiales_repuestos.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
