...
<form method="post" action="script/validaranuncio.php" enctype="multipart/form-data" >
    <div class="modal fade" id="anuncio" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
           <div class="modal-header">
                 <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                 <h4 class="modal-title" id="myModalLabel" align="center"><b>IMPORTANTE <?echo $pruebaget;?></b>
              <img src="" height="60px"></h4>
           </div>
           <div class="modal-body">
               <h5 class="modal-title" id="myModalLabel"><b></h5>
            <div class="form-group">

                <input  name="leer" type="hidden" class="form-control" value="0" aria-label="...">
                <input  name="inbox" type="hidden" class="form-control" value="" aria-label="...">
          ...
          <button type="submit" class="btn btn-primary">De acuerdo lo he leído</button>
  ...
  <div class="table-responsive" align="center">
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $row[   'destino'   ];  ?>  </td>
                           ...
                           <!-- MIENZO DE PARTE QUE SE OCULTA -->  <tr class="Galleta_Chica" >

                                    <!--Bloque para dar separacion --> <td width="10%"></td><!-- FIN BLOQUE SEPARACION -->
                                  ...
                                  <!--INICIO BLOQUE STATUS -->   <td><b><span>STATUS </span> </b><br>
...
<!-- BUSCANDO LAS FOTOS QUE PERTENECEN A LA ORDEN DENTRO DEL WHILE-->
 ...
 <!--Bloque para dar separacion --> <td width="2%">
...
<td><!--INICIO DE BLOQUE PARA FOTOS-->
  ...
  <br><br>
          ...
          <a data-fancybox data-type="iframe" href="fotos_nuevo.php">
            <img src="assets/images/cargando.png"  width="100">
          </a>
   ...
   <a href="#"><img src="assets/images/evento.png"  width="100"></a>
