...
if ($action == 'ajax') {
  ...
  if ($nivel == 5) {
    $count_query = mysqli_query($con, "select * from campos where impresion='0'");
  } else if ($nivel == 4) {
    $count_query = mysqli_query($con, "select * from campos where computo='0'");
  } else {
  ...
  if ($nivel == 5) {
    ...
    $query = mysqli_query($con, "select distinct a.scan, a.id_orden, a.id_empresa, a.empresa, a.id_contacto, a.contacto, a.fecha_orden, a.fecha_entrega, a.vendedor, a.usuario, a.estado, a.computo, a.impresion, a.id_cliente, a.cliente, a.scan, b.id_orden from campos a inner join campos_detalle b on a.id_orden=b.id_orden where a.impresion='0' and a.id_orden LIKE '%" . $query2 . "%'  order by a.id_orden desc  LIMIT $offset,$per_page");
    //loop through fetched data
  } elseif ($nivel == 4) {
    $query = mysqli_query($con, "select distinct a.scan, a.id_orden, a.id_empresa, a.empresa, a.id_contacto, a.contacto, a.fecha_orden, a.fecha_entrega, a.vendedor, a.usuario, a.estado, a.computo, a.impresion, a.id_cliente, a.cliente, a.scan, b.id_orden from campos a inner join campos_detalle b on a.id_orden=b.id_orden where a.computo=0 and a.id_orden LIKE '%" . $query2 . "%'  order by a.id_orden desc  LIMIT $offset,$per_page");
  } else {

    $query = mysqli_query($con, "select distinct a.scan, a.id_orden, a.id_empresa, a.empresa, a.id_contacto, a.contacto, a.fecha_orden, a.fecha_entrega, a.vendedor, a.usuario, a.estado, a.computo, a.impresion, a.id_cliente, a.cliente, a.scan, b.id_orden from campos a inner join campos_detalle b on a.id_orden=b.id_orden where a.estado='0' and a.id_orden LIKE '%" . $query2 . "%'  order by a.id_orden desc  LIMIT $offset,$per_page");
  }
  ...
  if ($numrows > 0) {
          ...
          while ($row = mysqli_fetch_assoc($query)) {
            ...
            if ($base == "esa" || $base == "nica") {
              ...
              if ($nivel == 1 || $nivel == 2 || $nivel == 3 || $nivel == 9) { ?>
                ...
                <td>
                  <?php echo '<a id="r' . $row['id_orden'] . '" href="#rem' . $row['id_orden'] . '" role="button"  data-toggle="modal" class="btn bg-success"><i class="fas fa-print"></i></a>'; ?>
                  <a data-fancybox data-options='{"data-backdrop":"static", "type" : "iframe", "iframe" : {"preload" : false } }'
                    href="reportes/produccion.imprimir.campos.php?idorden=<?php echo $row['id_orden']; ?>" class="btn bg-success"><i
                      class="fas fa-file-pdf"></i></a>
                </td>
              <?php } else { ?>

                <td>
                  <?php echo '<a  data-toggle="modal" data-target="#no" class="btn bg-success"><i class="fas fa-print"></i></a>'; ?>
            ...
            if ($base == "esa" || $base == "nica") {
              ...
              if ($nivel == 1 || $nivel == 2 || $nivel == 9) { ?>
                ...
                <td>
                  ...
                  <a data-fancybox data-options='{"data-backdrop":"static", "type" : "iframe", "iframe" : {"preload" : false } }'
                    href="formop3_campos.php?id_orden=<?php echo $row['id_orden']; ?>" class="edit"><i class="material-icons"
    ...
    <div class="collapse multi-collapse" id=' . $data2 . ' style="width:100%" >
      <div class="card card-body"><br>';
            ...
            include("consulta_item_op_campos_fin.php"); ?>
        ...
        <script>
          ...
          function <?php echo $n_funcion; ?>(str) {
            ...
            xmlhttp.open("GET", "getuser_op_campos_fin.php?q=" + str, true);
            xmlhttp.send();
          }
        </script>
        <tr>
