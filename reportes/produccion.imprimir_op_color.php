...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" style="border:solid #999999 1px">
    ...
    $id=$_GET['idorden'];
    $sql="SELECT * FROM orden WHERE id_orden='$id'";
    ...
    $sql2="SELECT * from orden_detalle  WHERE estado!='ANULADA' AND id_orden='$id' order by id_orden";
    ...
    while($row=$rs2->fetch_assoc()){
      ...
      ?>
          ...
          <tr>
            ...
            <td><strong>:</strong><?=$row['base']?>&nbsp;(base)&nbsp;x&nbsp;<?=$row['altura']?>&nbsp;(altura) CM</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
