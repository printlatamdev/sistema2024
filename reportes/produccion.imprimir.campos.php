...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" style="border:solid #999999 1px">
    ...
    $id=$_GET['idorden'];
    $sql="SELECT * FROM campos WHERE id_orden='$id'";
    ...
    $rs=$mysqli->query($sql);
      ...
      ?>
          ...
          <tr>
            ...
            <td align="left" bgcolor="#F4F4F4"><strong>:</strong>&nbsp;<?=utf8_decode($cliente)?></td>
          </tr>
        ...
        <tr>
          ...
          <?=utf8_decode($empresa)?></td>
        </tr>          
          <?
		 

    $sql2="SELECT * from campos_detalle  WHERE estado!='ANULADA' AND id_orden='$id' order by id_orden";
    ...
    while($row=$rs2->fetch_assoc()){
          ...
          <td colspan="3" ><strong>:</strong>&nbsp;<?=strtoupper(utf8_decode($row['trabajo']))?></tr>
          <tr>
            <td>&nbsp;</td>
            ...
            <td><strong>:</strong><?=$row['base']?>&nbsp;(base)&nbsp;x&nbsp;<?=$row['altura']?>&nbsp;(altura) Metros</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
        ...
        <?=$row['detalle']?> - <strong>Otros: </strong>&nbsp;<?=utf8_decode($row['acabado'])?>.</tr>
