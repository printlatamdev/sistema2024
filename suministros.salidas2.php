                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-9">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <select id="orden" name="orden" class="select2_category form-control" tabindex="1" required>
                                        <?php
                                        ...
                                        //consulta para que muestre las op que tienen a partir de la fecha actual a 3 dias anteriores para pop y op.
                                        //para pop
                                        //$rs=$mysqli->query("select * from pop where estado != 3 and fecha_orden <= NOW() AND fecha_orden >= date_add(NOW(), INTERVAL -4 DAY)");
                                        $rs2 = $mysqli->query("SELECT * FROM orden ");
                                        //para op
                                        //$rs2=$mysqli->query("select * from orden where estado != 3 and fecha_orden <= NOW() AND fecha_orden >= date_add(NOW(), INTERVAL -4 DAY)");
                              ...
                              <div class="col-md-9">
                                <div class="form-group">
                                  ...
                                  <div class="col-md-9">
                                    <div class="radio-list">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                      <label class="radio-inline">
                                        <input type="checkbox" name="pop" id="pop" value="1" />
                                      </label>
                              ...
                              <div class="col-md-9">
                                <div class="form-group">
                                  ...
                                  <div class="col-md-9">
                                    <div class="radio-list">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                      <label class="radio-inline">
                                        <input class="rad" type="radio" name="empresa" id="empresa" value="color" />

                                        Color</label>
                                      <label class="radio-inline">
                                        <input class="rad" type="radio" name="empresa" id="empresa" value="campos" />
                                        Campos </label>

                                      <label class="radio-inline">
                                        <input class="rad" type="radio" name="empresa" id="empresa" value="nicaragua" />
                                        Nicaragua</label>
                                    </div>
                                  </div>
                                </div>
