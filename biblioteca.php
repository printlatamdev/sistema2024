...
$sql="select a.id_proyecto, a.nombre, a.fecha, a.id_empresa, a.empresa, a.id_marca, a.marca, b.id_orden, b.id_proyecto, b.nombre_proyecto, b.fecha_proyecto, c.id_orden, c.trabajo, c.detalle, c.arte from pop_proyecto a INNER JOIN pop b on a.id_proyecto=b.id_proyecto INNER JOIN pop_detalle c on b.id_orden=c.id_orden";
...
$url="ORDENES_POP/EL SALVADOR/".$row['id_orden']."/ARTES_".$row['id_orden']."/".$row['arte']."";
  ...
  ?>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
              <div class="custom-box">
                <div class="servicetitle" style="margin-top: -30px;">
                  <h4><?php echo $row['nombre'];?></h4>
                  <hr>
                </div>
                <div class="icn-main-container">
                  <span class="icn-container"><img src="<?echo $url;?>" width="40"></span>
                </div>
                <p><?php echo $row['empresa'];?></p>
                <ul class="pricing">
                  <li><?php echo $row['trabajo'];?></li>
                  <li>1 Domain</li>
                
                </ul>
                <a class="btn btn-theme" href="#">VER ARCHIVOS</a>
              </div>
              <!-- end custombox -->
            </div>
           <?php }?>
