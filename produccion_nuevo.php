                      ...
                      <div class="collapse multi-collapse" id='.$data2log.' style="width:100%" >
                        <div class="card card-body"><br>';?>
                         ...
                         <?echo '
                                        ...
                                        <div class="col-md-1">
                                          <img src="imagenes/view.png" data-toggle="modal" data-target="#fotos" onclick=\'pasarDatos2("'.$row['id_orden'].'","'.$row['empresa'].'","'.$row['destino'].'","'.$row['marca'].'","'.$row['nombre_proyecto'].'","ADMINISTRACION","FACTURA")\' class="img-thumbnail">
                                          <span>Factura '.$row['empresa'].'</span>
                                        </div>
                                        <div class="col-md-1">
                                          <img src="imagenes/view.png" data-toggle="modal" data-target="#21'.$row['id_orden'].'" onclick=\'pasarDatos2("'.$row['id_orden'].'","'.$row['empresa'].'","'.$row['destino'].'","'.$row['marca'].'","'.$row['nombre_proyecto'].'")\' class="img-thumbnail">
                                          <span>Factura '.$row['empresa'].'</span>
                                        </div>'?>
                                        <? $id_order=$row['id_orden']; echo $id_order;?>
                                      
                                        <a  data-fancybox data-options='{"type" : "iframe", "iframe" : {"preload" : true}}' href="iframe.administracion.php?idorden=<? echo $id_order; ?>&&item=FACTURA">
                                          <div class="col-md-1">
                                          <img src="imagenes/view.png" width="40" height="40">
                                          <span>Envio</span>
                                        </div>
                                        
                                      
                                        <? echo '<div class="col-md-1">
                                          <img src="imagenes/view.png" data-toggle="modal" data-target="#3'.$row['id_orden'].'" onclick=\'pasarDatos2("'.$row['id_orden'].'","'.$row['empresa'].'","'.$row['destino'].'","'.$row['marca'].'","'.$row['nombre_proyecto'].'")\' class="img-thumbnail">
                                          <span>Nota Remision</span>
                                        </div>
                                        
                                      
                                        <div class="col-md-1">
                                          <img src="imagenes/view.png" data-toggle="modal" data-target="#41'.$row['id_orden'].'" onclick=\'pasarDatos2("'.$row['id_orden'].'","'.$row['empresa'].'","'.$row['destino'].'","'.$row['marca'].'","'.$row['nombre_proyecto'].'")\' class="img-thumbnail">
