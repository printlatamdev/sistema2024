...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <!-- start: Css -->
    <link rel="stylesheet" type="text/css" href="p/asset/css/bootstrap.min.css">

      <!-- plugins -->
      <link rel="stylesheet" type="text/css" href="p/asset/css/plugins/font-awesome.min.css"/>
      <link rel="stylesheet" type="text/css" href="p/asset/css/plugins/simple-line-icons.css"/>
      <link rel="stylesheet" type="text/css" href="p/asset/css/plugins/animate.min.css"/>
      <link rel="stylesheet" type="text/css" href="p/asset/css/plugins/fullcalendar.min.css"/>
  <link href="p/asset/css/style.css" rel="stylesheet">
  <!-- end: Css -->

  <link rel="shortcut icon" href="p/asset/img/logomi.png">
          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                ...
                <li class="user-name"><span>Vladimir Martinez</span></li>
                  <li class="dropdown avatar-dropdown">
                   <img src="p/img/persona.png" class="img-circle avatar" alt="user name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"/>
            ...
            <div id="left-menu">
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                   ...
                   <div align="center"> <img src="p/asset/img/logo_color.png" width="170"></div>
                    <li class="time">
...
<script src="dist/js/demo.js"></script>
  ...
  <script src="ajax2/jquery-3.3.1.min.js" type="text/javascript"></script>
    ...
    <script src="p/asset/js/jquery.min.js"></script>
    <script src="p/asset/js/jquery.ui.min.js"></script>
    <script src="p/asset/js/bootstrap.min.js"></script>
   
    
    <!-- plugins -->
    <script src="p/asset/js/plugins/moment.min.js"></script>
    <script src="p/asset/js/plugins/fullcalendar.min.js"></script>
    <script src="p/asset/js/plugins/jquery.nicescroll.js"></script>
    <script src="p/asset/js/plugins/jquery.vmap.min.js"></script>
    <script src="p/asset/js/plugins/maps/jquery.vmap.world.js"></script>
    <script src="p/asset/js/plugins/jquery.vmap.sampledata.js"></script>
    <script src="p/asset/js/plugins/chart.min.js"></script>


    <!-- custom -->
     <script src="p/asset/js/main.js"></script>
     <script type="text/javascript">
      (function(jQuery){
