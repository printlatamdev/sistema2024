      ...
      <div class="table-responsive" align="center">
        ...
        <table  class="table table-striped table-hover">
                         ...
                         return false;        
                              ...
                              <tr>
                                <td align='center'><div id="<?echo $id;?>" style="width: 5px; height: 2px;">

                <h3></h3>

                <div style="width: 1300px; height: 500px;">
                    <iframe  src="tablas.php" frameborder="0" style="  position:relative; margin-top: -20px "  width="2000" height="600px" scrolling="no">
