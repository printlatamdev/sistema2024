  ...
  <a  data-fancybox data-options='{"type" : "iframe", "iframe" : {"preload" : false }}' href="form2.php"><i class="far fa-edit"></i></a>-->
          <div align="Left">
            <h3 class="page-header">
              ...
              SOLICITUDES DE DESPACHO NICARAGUA &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img src="imagenes/aereo.png"
          ...
          <div class="table-responsive">
            ...
            <table class="table table-striped table-hover">
              ...
              $sql = mysqli_query($conexion, "select distinct n_orden, proveedor,origen, transporte, destino, solicitud_pdf, fecha from solicitud_despacho");
            ...
            <tr style="font-size:85%;" >
                <td>NI' . $row['n_orden'] . '</td>
                <td>' . $row['proveedor'] . '</td>
                <td>' . $row['transporte'] . '</td>
                <td>' . $row['destino'] . '</td>
                <td>' . $row['origen'] . '</td>
                <td>' . $row['fecha'] . '</td>
                <td><a class="btn bg-success" href="logistica/SOLICITUDES DE DESPACHO/' . $row['solicitud_pdf'] . '" data-fancybox="preview"><i class="fas fa-file-alt"></i></a></td>
