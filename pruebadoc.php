      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <<li class="treeview">
          ...
          <ul class="treeview-menu">
             <li><a href=""><i class="fas fa-print"></i> <span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   ORDENES EN IMPRESION</span></a></li>
        <li><a href=""><i class="fas fa-cut"></i> <span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   ORDENES EN CORTE</span></a></li>
        <li><a href=""><i class="fas fa-cogs"></i> <span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ORDENES EN ACABADO</span></a></li>
          </ul>
        </li>
...
<!--COMIENZA MENU DE GUATEMALA Y HONDURAS-->
...
<!--FIN MENU DE GUATEMALA Y HONDURAS-->
...
<?php } ?>
<!--FIN MENU DE EL SALVADOR-->


<!--COMIENZA MENU DE COSTA RICA-->
  <?if($destino=="CR"|| $destino=="PN"){?>
    <td class="text-left">Cotizacion</td>
