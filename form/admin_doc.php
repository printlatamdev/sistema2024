...
<?php //while($rowe = mysqli_fetch_assoc($e)){echo $rowe['centrega'];} ?>
...
<div class="col-md-12">
  <?php if ($factura == 0) { ?>
    <div class="col-xs-1 col-md-1 col-lg-1">
      <input type="image" src="imagenes/no_pdf.png" class="img-thumbnail" data-toggle="modal"
        data-target="<?php echo $modal2; ?>">

    </div><?php } else { ?>
    <div class="col-xs-1 col-md-1 col-lg-1">
      <input type="image" src="imagenes/pdf.png" class="img-thumbnail" data-toggle="modal"
        data-target="<?php echo $modal2; ?>">
    </div>
...
<form method="post" action="form/subir_factura.php" enctype="multipart/form-data">
  <div class="modal fade" id="<?php echo $modal; ?>" tabindex="0" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
              ...
              <tbody>
                ...
                <?php } else { ?>
                  ...
                  <?php while ($row = mysqli_fetch_assoc($f)) { ?>
                    ...
                    <tr>
                      <th scope="row"><?php echo $cont;
                      $cont++; ?></th>



                      <td> <a href="ORDENES_OP/COLOR/<?php $pais; ?>/<?php echo $id; ?>/DOC/<?php echo $row['ccfiscal']; ?>"
        ...
        <div class="modal-footer">
          ...
          <button class="btn btn-default" data-dismiss="modal">Cancelar<?php $pais; ?></button>
        </div>
      </div>
    </div>
  </div>
...
<form method="post" action="form/subir_factura.php" enctype="multipart/form-data">
  <div class="modal fade" id="<?php echo $modalp; ?>" tabindex="0" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
            ...
            <table class="table" width="100">
              ...
              <tbody>
                ...
                <?php } else { ?>
                  ...
                  <?php while ($row = mysqli_fetch_assoc($p)) { ?>
                    ...
                    <tr>
                      <th scope="row"><?php echo $cont;
                      $cont++; ?></th>
                      <td> <a href="ORDENES_OP/COLOR/<?php $pais; ?>/<?php echo $id; ?>/DOC/<?php echo $row['cpago']; ?>"
                          data-fancybox="preview">
                          <input type="image" src="imagenes/pdf.png" class="img-thumbnail" width="60">
                        </a></td>
                    </tr>
...
<!-- ********************************************************************************************************************** -->
<form method="post" action="form/subir_factura.php" enctype="multipart/form-data">
  <div class="modal fade" id="<?php echo $modale; ?>" tabindex="0" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <table class="table" width="100">
              ...
              <tbody>
                ...
                <?php } else { ?>
                  <?php while ($rowe = mysqli_fetch_assoc($e)) {
                    ?>
                    ...
                    <tr>
                      ...
                      $cont++; ?></th>
                      <td> <a
                          href="ORDENES_OP/COLOR/<?php $pais; ?>/<?php echo $id; ?>/DOC/<?php echo $rowe['centrega']; ?>"
                          data-fancybox="preview">
                          <input type="image" src="imagenes/pdf.png" class="img-thumbnail" width="60">
                        </a></td>
                    </tr>
          ...
          <input type="hidden" value="<?php echo $id; ?>" name="id">
          <br>
          subir nota de envio. <?php echo $rowe['centrega']; ?>
          <input type="file" name="factura" required="required">
