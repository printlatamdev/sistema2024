...
if ($nivel==5) {
	...
	$res   = mysqli_query($con,"update pop_pliego SET impresion='".$estado."'  where id_detalle_pliego='".$si."'");

	$res2   = mysqli_query($con,"select*from pop_pliego  where id_detalle='".$item."' and impresion=1");
	$res3   = mysqli_query($con,"select*from pop_detalle  where id_orden='".$si_orden."' and impresion=1");
    

    $cuenta1 = mysqli_num_rows($res2);
...
$res   = mysqli_query($con,"update pop_pliego SET corte='".$estado."'  where id_detalle_pliego='".$si."'");

	$res2   = mysqli_query($con,"select*from pop_detalle  where id_orden='".$si_orden."' and corte=1");
	$res3   = mysqli_query($con,"select*from pop_pliego  where id_detalle='".$item."' and corte=1");
	
    

    $cuenta1 = mysqli_num_rows($res3);
...
$res   = mysqli_query($con,"update pop_pliego SET computo='".$estado."'  where id_detalle_pliego='".$si."'");

	$res2   = mysqli_query($con,"select*from pop_detalle  where id_orden='".$si_orden."' and computo=1");
    $res3   = mysqli_query($con,"select*from pop_pliego  where id_detalle='".$item."' and computo=1");
