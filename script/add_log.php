...
$nuevo=$mysqli->query("select id_orden from logitica where id_orden='$id_orden'");
...
if($res==true && $res2==true){
    ...
    window.location.href="../editar_logistica.php";
		...
		echo 'Error 2'.$id_orden.$id_marca.
$nombre_cliente.
$marca.
$origen.$destino;
	}
