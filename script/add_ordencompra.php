...
$res2 = $mysqli->query("update logitica SET numorden_compra='".$compra."' where id_orden='".$id_orden."'");
...
if($res2==true){
    ...
    window.location.href="../editar_ordencompra.php";
    </script>';
...
$res = $mysqli->query("update logitica SET numorden_compra='".$compra."' where id_orden='".$id_orden."'");
