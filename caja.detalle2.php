...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- BEGIN PAGE CONTENT-->
      <div class="row">
        <div class="col-md-3"><p><b><font size="4px" >CAJA CHICA</font></b></p>
          ...
          <?php
            ...
            $rs=$mysqli->query("SELECT DISTINCT mes  FROM `caja_saldos` ");
                        $flag=0;
              while ($fila = $rs->fetch_row()) 
                { 
                  $mes=$fila[0];
                           ...
                           <i class="fa  fa-calendar"></i><strong>'.$mes.'</strong></a>
                             </li>';
          ...
          <div class="tab-content">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                            <i class="icon-wallet"></i> Caja Chica de '.$mes.'
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            ...
                            <tr>
                                ...
                                <th align="center">Fecha Finalizacion</th>
                                <th align="center">Saldo Transferido</th>
                            ...
                            <tbody> ';
                             ...
                             $rs2=$mysqli->query("SELECT *  FROM `caja_saldos` WHERE mes='".$mes."' ORDER BY id_saldo DESC ");
                            ...
                            <td>
                            <storng>'.$fila2['id_saldo'].'</storng> 
                            </td>
                                <td align="center">
                                     <storng>'.$fila2['fecha_ini'].'</storng> 
                                </td>
                                <td align="center">
                                   <b> '.$fila2['fecha_fin'].'</b>
                                </td>
                                <td align="center">
                                    C$ '.$fila2['saldo_transferido'].'
                                </td>
                                <td align="center">
                                   C$ '.$fila2['saldo_inicial'].' 
                                </td>
                               
                                <td align="center">
                                <a target="_blank" href="caja.reporte.detalle.php?id_saldo='.$fila2['id_saldo'].'&ini='.$fila2['fecha_ini'].'&fin='.$fila2['fecha_fin'].'&saldo='.$fila2['saldo_inicial'].'&tran='.$fila2['saldo_transferido'].'" >Mostrar</a>
                                </td>
                            </tr>';
...
<!--  
 ...
 <td align="center"><a target="_blank" href="http://'.$uri.'/caja_'.$_SESSION['base'].$_SESSION['year'].'/transfer/'.$fila2['trans'].'" >Ver</a>
                                
                                </td>
                                <td align="center"><a target="_blank" href="http://'.$uri.'/caja_'.$_SESSION['base'].$_SESSION['year'].'/comprobante/'.$fila2['retiro'].'" >Ver</a>
