...
/**CONSULTA ANTIGUA
 ...
 t1 inner join pop_detalle t5 on t1.id_orden=t5.id_orden inner join pop t2 on t5.id_orden=t2.id_orden inner join contacto t3 on t2.id_contacto=t3.id_contacto inner JOIN pop_marca t4 on t1.id_marca=t4.id_marca where t1.estado=1 and status='CORTE'   and t2.id_empresa='".$id."' order by t5.cot desc
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    --><br>
       ...
       <td>ORDENES EN CORTE :&nbsp;&nbsp;&nbsp;&nbsp;<img height='50px' src="focus/corte.png" /> </td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  &nbsp;&nbsp;&nbsp;&nbsp;
