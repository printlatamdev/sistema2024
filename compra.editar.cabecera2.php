          ...
          <div class="col-md-8">
            ...
            <div id="contenedor1" class="portlet box blue">
              <div class="portlet-title">
                <div class="caption">
                  <i class=" icon-book-open font-green-sunglo"></i> Editar Orden Compra - #<?= $compra ?>
                </div>
              ...
              <div class="portlet-body form">
                ...
                <form id="crea" action="compra.sql.php" class="horizontal-form" method="post">
                  <input type="hidden" name="bandera" value="7">
                  ...
                  <div class="form-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <label
                            class="control-label "><strong>OP:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                          <label class="control-label "><strong>POP:</strong></label><input type="checkbox" name="pop"
                            id="pop" value="1" />

                          <input id="op" name="op" type="text" onkeypress="return isNumberKey(event)"
                            class="form-control">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <select id="solicita" name="solicita" class="select2_category form-control" tabindex="1">
                              ...
                              $rs = $mysqli->query("SELECT * FROM compra_usuarios WHERE estado='1'");
                              while ($fila = $rs->fetch_row()) {
                                echo '<option value="' . $fila[0] . '">' . $fila[1] . '</option>';
                              }
                              $mysqli->close();
                    ...
                    <div class="form-actions left">
                      <button id="nueva_compra" type="button" class="btn blue">Editar Orden Compra</button>
                    </div>
                </form>
                <!-- END FORM-->
              </div>
