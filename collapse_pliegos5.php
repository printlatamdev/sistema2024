...
<!--<div id="txtHint"><b>Person info will be listed here.</b></div>-->
      ...
      <div id="resultado2" class="card-body"></div>
        ...
        <a  data-fancybox data-options='{"type" : "iframe", "iframe" : {"preload" : false }}' href="form2.php"> <input type=image src="icono/add.png"  width="60" height="60"></a>  Agregar Orden. <? echo $var;?>
      <hr />
