...
<!--<div id="txtHint"><b>Person info will be listed here.</b></div>-->
 ...
 <!-- IFRAME 
      ...
      <div id="resultado2" class="card-body"></div>
        ...
        <a  data-fancybox data-options='{"data-backdrop":"static", "type" : "iframe", "iframe" : {"preload" : false } }' href="formop2_campos.php"> <input type=image src="icono/add.png"  width="60" height="60"></a>  Agregar Orden.
      <hr />
        ...
        if(mysqli_num_rows($sql) == 0){
          ...
          while($row = mysqli_fetch_assoc($sql)){
            ...
            echo '
              ...
              <td>
                  <a  data-fancybox data-options='{"data-backdrop":"static", "type" : "iframe", "iframe" : {"preload" : false } }' href="formop3_campos.php?id_orden=<?echo $row['id_orden']; ?>" class="btn bg-primary"><i class="far fa-edit"></i></a>
