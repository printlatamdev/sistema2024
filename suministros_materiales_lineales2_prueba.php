    ...
    <div class="content-wrapper">
      ...
      <div class="container col-xs-12 col-md-12 col-lg-12 col-xl-12" style="margin-left: 10px;">
        ...
        <div class="row">
          <div class="col-md-3">
            <p><b>
                <!-- <font size="4px"><a style="color: #000;" href="suministros.reporte.materiales.metros.php">METROS LINEALES</a></font> -->
                <font size="4px"><a style="color: #000;" href="suministros_materiales_lineales2.php">METROS LINEALES</a>
                </font>
              </b>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <b>
                <font size="3px"><a style="color: #000;" href="suministros_materiales_lineales2.php?flag=0">Existencias
                    0</a></font>
              </b>
            </p>
            ...
            <ul class="ver-inline-menu tabbable margin-bottom-10">
              ...
              if ($base == 'esa') {
                ...
                //echo $base;
                include('suministros/nica_db.php');
              }
            ...
            <div class="tab-content">
              ...
              while ($fila = $rs->fetch_row()) {
                ...
                if ($nivel == 4 or $nivel == 8 or $nivel == 1) {
                  ...
                  if ($material == 'Lona') {
                    echo headerLona($flag, $material);
                  } elseif ($material == 'Vinyl') {
                    echo headerVinyl($flag, $material);
                  } else {
                    echo '                             
                    ...
                    <div class="portlet box yellow">
                        ...
                        <div class="portlet-body">
                            ...
                            <tr>
                              ...
                              <th>Info</th>
                              <th>Tipo</th>
                              <th align="center"> <center>  Cantidad (Unidades) </center> </th>
                              <th align="center"><center>Medidas</center></th>                                                              
                            </tr>
                            </thead>
                            <tbody> ';
                  }
                ...
                if (isset($_REQUEST['flag'])) {
                  $rs2 = $mysqli->query("SELECT *  FROM `material` WHERE material='" . $material . "' AND cantidad='0'  AND estado='1'  AND cantidad!='null'");
                } else {
                  $rs2 = $mysqli->query("SELECT *  FROM `material` WHERE material='" . $material . "' AND cantidad NOT LIKE '0'  AND estado='1'  AND cantidad!='null'");
                }
                ...
                while ($fila2 = $rs2->fetch_row()) {
                  ...
                  // $marca = $fila2[13];
                  $lona_marca = $fila2[13] !== null ? explode("|", $fila2[13], 2) : [];
                  // $lona_marca = $fila2[13];
                  ...
                  if ($nivel == 4 or $nivel == 8 or $nivel == 1) {
                    //Llenado de datos Que corresponden a LONA
                    if ($fila2[1] == 'Lona') {
                      $marca = $lona_marca;
                      echo '
                      <tr class="odd gradeX">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="form-group">
                    Id Material<input id="id_sub" type="text" class="form-control" name="id_orden" aria-label="..."
                  ...
                  <div class="form-group">
                    <input name="origen" type="hidden" value="<?php echo $_SESSION['base']; ?>" class="form-control"
                      aria-label="...">
                  </div>
          ...
          <div class="modal fade" id="nota2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="form-group">
                    <input id="id_m" type="text" class="form-control" name="id_orden" aria-label="..."
                      readonly="readonly" required>
                  </div>
                  <div align="center">
                    <h6>*ACTUALMENTE YA HAS SUBIDO UNA FOTO, PERO PUEDES ACTUALIZARLA*</h6>
                  </div>
                  <br>
                  <br>
             ...
             <div align="center">
               ver imagen <a href="#" onclick="top.window.location.href='../sistema/artes_esa17/'+document.getElementById('imagen').value ; return !1"  class="fancybox" rel="ligthbox">
                  ...
                  <div align="center"> <a id="img" onclick="myFunction6(document.getElementById('img').value)" href='#'
                      role='button' class="rotate"><i></i> Click para ver <img align="center"
                        src="../sistema/artes_esa17/IMGPDF/ver3.png" height="80px" class="zoom img-fluid " alt=""> </a>
                  </div>
                  <div class="form-group">
                    <input name="origen" type="hidden" value="<?php echo $_SESSION['base']; ?>" class="form-control"
                      aria-label="...">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <?php $var1 = '<p  id="id_modificar"></p>'; ?>
                <h4 class="modal-title" id="myModalLabel">Descripciones <?php echo $var1; ?></h4>
              </div>
              <div class="modal-body">
                <h5 class="modal-title" id="myModalLabel">Material:</h5>

                <div class="form-group">
                  <input id="id_modificar" type="text" class="form-control" name="id" readonly="readonly"
                    aria-label="..." required>
                </div>
                ...
                <div class="form-group">
                  <input id="tipo2" type="text" class="form-control" name="tipo2" readonly="readonly" aria-label="..."
                    required>
                </div>
                <br>
                ...
                <div class="form-group">
                  Descripcion <textarea id="nombre" type="text" class="form-control" name="descripcion" aria-label="..."
                    required></textarea>
                </div>
                <div class="form-group">
                  <input type="hidden" class="form-control" name="tipo" aria-label="..." value="metros">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <h5 class="modal-title" id="myModalLabel">Material:</h5>
                <div class="form-group">
                  <input id="indice" type="text" class="form-control" name="id" readonly="readonly" aria-label="..."
                    required>
                </div>
                <div class="form-group">
                  <input id="nombre" type="text" class="form-control" name="tipo" readonly="readonly" aria-label="..."
                    required>
                </div>
                <br>
                ...
                <div class="form-group">
                  Descripcion <textarea id="nombre" type="text" class="form-control" name="descripcion" aria-label="..."
                    placeholder="Ingrese una descripcion de este material" required></textarea>
                </div>
                <div class="form-group">
                  <input type="hidden" class="form-control" name="tipo" aria-label="..." value="metros">
                </div>
...
// ENCABEZADOS DE LA TABLAS
function headerLona($flag, $material)
{
  return '                             
    <div id="tab_' . $flag . '" class="tab-pane">
    <div id="accordion' . $flag . '" class="panel-group">
...
function headerVinyl($flag, $material)
{
  return '                             
    <div id="tab_' . $flag . '" class="tab-pane">
    <div id="accordion' . $flag . '" class="panel-group">
