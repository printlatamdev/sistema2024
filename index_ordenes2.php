...
<?php }else{ ?>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            ...
            <a href="compra.editar2.php">
              <div class="info-box-content">
                <span class="info-box-text">EDITAR O.C</span>
  ...
  <?php endif ?>
       ...
       <a href="compra.search2.php">
              <div class="info-box-content">
                <span class="info-box-text">BUSCAR O.C</span>
                <span class="info-box-number"></span>
              </div>
              <!-- /.info-box-content -->
            </div></a>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
             <span class="info-box-icon bg-warning elevation-1"><i class="fas fa-bookmark"></i></span>
                        <a href="compra.control2.php"> 

              <div class="info-box-content">
                <span class="info-box-text">REPORTES O.C</span>
                <span class="info-box-number"></span>
              </div>
              <!-- /.info-box-content -->
            </div></a>
        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <a href="compra.documentacion2.php">
              <div class="info-box-content">
