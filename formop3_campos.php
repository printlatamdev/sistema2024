...
if (trim($id_detalle_orden) == false) {
  ...
  $var = 0;
  $action = 'form/nueva_op/insertar_item_op_campos.php?id_orden=' . $orderid . '';

} else {
  $hola = $id_detalle_orden;

  $modificares = mysqli_query($conexion, "select*from campos_detalle where id_detalle_orden='" . $id_detalle_orden . "'");
  $action = 'form/nueva_op/update_item_op_campos.php?id_detalle_orden=' . $id_detalle_orden . '';
...
<body>
  ...
  <div id="msform">
    <form action="<?php echo $action; ?>" method="POST" enctype="multipart/form-data"
      style="margin-top: 5px;margin-left: -40px;width: 1000px; height: 1000px;">
      ...
      <fieldset>
        ...
        <div class="row">
          ...
          <?php if ($var == 1) {
            include('form/form_editar_item_op_campos.php');
          } else {
            include('form/nuevo_item_op_campos.php');
          }
          ?>
        </div>
