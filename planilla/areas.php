...
<body>
 ...
 <div class="col-sm-6">
            <a href="#newModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Agregar Nueva Area</span></a>
          </div>
...
function loadTabla(){
  ...
  $.get("html/tabla.php","",function(data){
    $("#tabla").html(data);
  })
...
loadTabla();
  ...
  $("#agregar").submit(function(e){
    e.preventDefault();
    $.post("html/agregar.php",$("#agregar").serialize(),function(data){
    });
