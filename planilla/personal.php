...
<body>
 ...
 <div class="col-sm-6">
            <a href="#newModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Agregar Nuevo Empleado</span></a>
          </div>
...
function loadTabla(){
  ...
  $.get("html/tabla_empleado.php","",function(data){
    $("#tabla").html(data);
  })
