              ...
              <tbody>
                  ...
                  if ($rs->num_rows > 0) {
                      ...
                      while ($row = $rs->fetch_assoc()) {
                          // Alternar entre clases "odd" y "even"
                          $class = $f % 2 == 0 ? 'even' : 'odd';

                          // Verificar si el precio está vacío
                          $precio = !empty($row['precio']) ? $row['precio'] : "0.00";

                          echo "
                          <tr class='" . $class . "'>
                              <td><b>" . htmlspecialchars($row['material'] . " - " . $row['tipo']) . "</b></td>
                              <td><b>" . htmlspecialchars($row['medicion']) . "</b></td>
                              <td><b>$ " . htmlspecialchars($precio) . "</b></td>
                              <td><b><a href='#myModal_" . $f . "' role='button' data-toggle='modal'>Editar</a></b></td>
                          </tr>";
                          
                          $f++; // Incrementar el contador
                      }
                  } else {
                      echo "<tr><td colspan='4'>No hay materiales disponibles</td></tr>";
                  }
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <div class="input-group">
                        ...
                        <input type="text" value="<?= $row['precio'] ?>" id="typeahead_example_modal_1" name="precio"
