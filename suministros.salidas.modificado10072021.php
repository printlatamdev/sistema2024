                          ...
                          <div class="col-md-9">
                            <div class="form-group">
                              ...
                              <div class="col-md-9">
                                ...
                                ?>
                                      <option value="0000">SIN POP</option> <?php
                                       while ($fila = $rs->fetch_row()) { echo '<option value="'.$fila[0].'">'.$fila[0].' - '.$fila[15].'-POP'.'</option>'; }
                                       while ($fila2 = $rs2->fetch_row()) { echo '<option value="'.$fila2[0].'">'.$fila2[0].' - '.$fila2[2].'-OP'.'</option>'; }
                                       while ($fila3 = $rs3->fetch_row()) { echo '<option value="'.$fila3[0].'">'.$fila3[0].' - '.$fila3[2].'-CAMPOS'.'</option>'; }
                                    $mysqli->close();
                                ?>
  ...
  <div id="modal45" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>
             <center><h4><strong>El Codigo <label id="code45"></label> no existe. Reingrese el codigo.</strong></h4></center>
          </p>
        </div>
        <div class="modal-footer">
          <button data-dismiss="modal" class="btn red">OK</button>
