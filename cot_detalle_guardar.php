...
if (isset($_REQUEST["orden"])) {
   ...
   $rs_en=$mysqli->query("SELECT * FROM cotizacion WHERE id_cotizacion='".$orden."'");
     while ($fila_en = $rs_en->fetch_assoc()) {  $empresa = $fila_en["empresa"]; $contacto = $fila_en["contacto"]; $vendedor = $fila_en["vendedor"]; $fecha = $fila_en["fecha"]; }
              ...
              <div  id="contenedor3" class="portlet box blue">
                <div class="portlet-title">
                  <div class="caption">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <a href="cot.editar.cabecera.php?cot=<?=$orden?>"><font color="white">Editar Cabecera</font></a>
                  </div>
            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                  ...
                  <div class="form-group form-md-line-input">
                    <textarea name="detalle" id="detalle" class="form-control" rows="5" placeholder="Ingrese el detalle"><?=$textarea?></textarea>
          ...
          <div id="details" class="portlet box blue">
            ...
            <div class="portlet-body">
              ...
              if (isset($_REQUEST["orden"])) {
                 ...
                 $rs_as=$mysqli->query("SELECT * FROM cotizacion_detalle WHERE id_cotizacion='".$orden."'");
