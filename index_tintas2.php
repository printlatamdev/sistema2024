...
<div class="wrapper">
  ...
  <div class="content-wrapper">
     ...
     <div class="container col-xs-12 col-md-12 col-lg-12 col-xl-12" style="margin-top: -40px;"  >
...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////-->
   <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <a href="suministros.reporte.tintas2.php">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            ...
            <!-- <a href="<?= $base == 'esa'? 'suministros_materiales_lineales2_prueba.php' : 'suministros_materiales_lineales2.php'?>"> -->
            <a href="suministros_materiales_lineales2.php">

              <div class="info-box-content">
                <span class="info-box-text">METROS LINEALES</span>
       ...
       <!-- <a href="<?= $base == 'esa'? 'suministros_materiales_rigidos2_prueba.php' : 'suministros_materiales_rigidos2.php'?>"> -->
          <a href="suministros_materiales_rigidos2.php">
              <div class="info-box-content">
                <span class="info-box-text">RIGIDOS</span>
                <span class="info-box-number"></span>
              </div>
              <!-- /.info-box-content -->
            </div></a>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
             <span class="info-box-icon bg-warning elevation-1"><i class="fas fa-bookmark"></i></span>
                        <a href="suministros_materiales_display2.php"> 

              <div class="info-box-content">
                <span class="info-box-text">DISPLAY</span>
                <span class="info-box-number"></span>
              </div>
              <!-- /.info-box-content -->
            </div></a>
...
<!-- ******************************************************************************************************-->
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <a href="suministros_materiales_accesorios2.php">
              <div class="info-box-content">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            ...
            <a href="suministros_materiales_telas2.php">
              <div class="info-box-content">
                <span class="info-box-text">TELAS</span>
                <span class="info-box-number"></span>
              </div>
              <!-- /.info-box-content -->
            </div></a>
       ...
       <a href="suministros_materiales_repuestos2.php">
              <div class="info-box-content">
