			...
			<?
				...
				//-----------------------------------------------------
                 ...
                 $detalle= str_replace($search, $replace, $subject);
				  ...
				  echo "<tr><td colspan='2' ><font size='2'>".$detalle."</font></td><td align='center' width='14%' ><font size='2'>".$cantidad."</font></td><td align='center'   ><font size='2'>C$".$precio."</font></td><td width='13%' align='center'><font size='2'><strong>C$".number_format($costo_total, 2, '.', ',')."</strong></font></td></tr> ";
