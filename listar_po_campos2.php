...
if($action == 'ajax'){
  ...
  while($rowac = mysqli_fetch_assoc($querycon)){
    ...
    if ($computoac == 1) {
       $queryactualizar = mysqli_query($con,"UPDATE campos set computo='1', estado='1' where id_orden='".$idordenac."'");
    }
    if ($impreac == 1) {
      $queryactualizar = mysqli_query($con,"UPDATE campos set impresion='1', estado='1' where id_orden='".$idordenac."'");
    }
  }
