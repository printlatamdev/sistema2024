   ...
   <!-- pegar aqui el contenido--> 
      ...
      <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
            <h2>Orden # <?echo $popop?> <b>PO Campos</b></h2>
          </div>
   ...
   <div class='col-sm-4 pull-right'>
        <div id="custom-search-input">
                            <div class="input-group col-md-12">
                                <input type="hidden" class="form-control" value="<?echo $popop;?>" id="q" onkeyup="load(1);" />
...
<strong>La orden fue creada con exito!</strong>  
  ...
  <script src="script_op_campos_individual.js"></script>
