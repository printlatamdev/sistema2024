...
while ($row25 = mysqli_fetch_array($consulta155))
        ...
        <li class="treeview">
          <a href="index_fotos.php">
            <i class="fas fa-print"></i> <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?echo $num_compra;?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a><?$consulta78 = mysqli_query($conexion,"select id_orden from logiticass WHERE numorden_compra='".$num_compra."'");?>
...
<ul class="treeview-menu">
   ...
   <?while ($row27 = mysqli_fetch_array($consulta78))
                                   {   $id_orden=$row27[0];
                                       //$codigo=$row25[2];?> 
             <li><a href="vista_impresion.php"><i class="fas fa-print"></i> <span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <?echo $id_orden;?></span></a></li>
                    <?}?>
          </ul>
        </li>
