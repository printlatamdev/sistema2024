...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <!-- pegar aqui el contenido--> 
      ...
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Nuevo Articulo</button>
  ...
  <script src="js/script_po.js"></script>
