          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                 <? echo $nombre;?>
                  <small>Uso exclusivo para clientes 2019<?echo $nombre.$id;?></small>
                </p>
              </li>
              <!-- Menu Body -->
        ...
        <table  class="table table-striped table-hover">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <?
                                  echo" <td align='center'><a onclick=\"myFunction4(".$row['id_orden'].")\" href='' role='button'  data-toggle='modal'><i class='far fa-file'></i></a></td>"
