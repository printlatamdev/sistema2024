...
if($nivel==1 || $nivel==2){
	...
	$pt5='../../artes/'.$year.'/PRUEBA/'.$proyecto.'/DISENO';
	...
	$pt2='../../artes/'.$year.'/DISPLAYS/'.$empresa.'/'.$marca.'/'.$proyecto.'/DISENO/Instructivo';

	$pt3='../../artes/'.$year.'/DISPLAYS/'.$empresa.'/'.$marca.'/'.$proyecto.'/DISENO/Renders_Aprobados';
