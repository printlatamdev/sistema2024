...
<html>
	<head>
		...
		<script type="text/javascript" charset="utf-8">
			...
			$(document).ready(function() {
				$('#elfinder').elfinder({
					url : 'php/connector.minimal822.php?empresa=<?=$empresa?>&marca=<?=$marca?>&proyecto=<?=$proyecto?>&nivel=<?=$nivel?>&year=<?=$year?>&tipo=<?=$tipo?>&base=<?=$base?>',  // connector URL (REQUIRED)
				    lang: 'es',
				    height: '600px'
	...
	<body>
        ...
        <p style="font-family:verdana" ><?=$proyecto.$year?></p>
