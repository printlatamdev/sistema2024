...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <nav class="menu-navigation-dark">
     <a href="fotoprueba.php?id=<?php echo $id; ?>"><i class="fa fa-camera-retro"></i><span>Fotos Cargando</span></a>
    <a href="fotoprueba2.php?id=<?php echo base64_encode($id); ?>"><i class="fa fa-camera-retro"></i><span>Fotos evento</span></a>
    <a href="fotoprueba3.php?id=<?php echo base64_encode($id); ?>"> <i class="fa fa-camera-retro"></i><span>Fotos Entrega</span></a>
