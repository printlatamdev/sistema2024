      ...
      <div class="row">
        <div class="col-md-3"><p><b><font size="4px" >REPUESTOS</font></b></p>
          ...
          <?php
            ...
            $rs=$mysqli->query("SELECT DISTINCT material  FROM `material22` WHERE medicion='repuestos'");
                        $flag=0;
                    ...
                    <div class="portlet box yellow">
                        ...
                        <div class="portlet-body">
                            ...
                            <tbody> ';
                             ...
                             $rs2=$mysqli->query("SELECT *  FROM `material22` WHERE material='".$material."' AND medicion='repuestos' and  estado='1'");
