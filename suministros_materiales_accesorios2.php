        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <ul class="ver-inline-menu tabbable margin-bottom-10">
              ...
              $rs = $mysqli->query("SELECT DISTINCT material  FROM `material` WHERE medicion='accesorios'");
              $flag = 0;
              while ($fila = $rs->fetch_row()) {
                ...
                echo '<li style="height:45px;">
                           ...
                           <img src="suministros/iconossuministros/suministros.png" width="30px" height="30px"><strong>' . $material . '</strong></a>
                             </li>';
              }
            ...
            <div class="tab-content">
              ...
              while ($fila = $rs->fetch_row()) {
                ...
                if ($nivel == 4 or $nivel == 8 or $nivel == 1) {
                  echo '<div id="tab_' . $flag . '" class="tab-pane">
                  ...
                  /*<th align="center">
                                ...
                                <th align="center">
                                   <center>  Medidas (Unidades) </center>
                                </th >*/
                }
                /*
                                 <th align="center">
                                ...
                                //es parte de la tabla que esta arriba
                              */
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <input type="hidden" class="form-control" name="tipo" aria-label="..." value="accesorios">
