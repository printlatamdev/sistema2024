            ...
            <div class="col-md-9">
              ...
              <div  id="contenedor1" class="portlet box blue">
                ...
                <div class="portlet-title">
                  <div class="caption">
                    <i class="icon-settings"></i> Nuevo Expediente
                  </div>
                ...
                <div class="portlet-body form">
                  <div class="tab-content">
                                       ...
                                       <div class="tab-pane active" id="portlet_tab_1_1"> <!-- **********************POP ********************************* -->
                  ...
                  <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form id="fomr1" method="post" action="expediente.sql.php" class="form-horizontal">
                          ...
                          <div class="col-md-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                  ...
                                  <input autocomplete="off" required id="inicio" name="inicio" type="text" class="form-control" data-uk-datepicker="{format:'DD-MM-YYYY', i18n:{ months:['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre',  ] } }">
                              ...
                              <div class="col-md-5">
                                    <label class="control-label "><strong>Vencimineto de Periodo Prueba:</strong></label>
                                    <div class="input-group input-medium " >
                                  <input autocomplete="off" id="prueba" name="prueba" type="text" class="form-control" data-uk-datepicker="{format:'DD-MM-YYYY', i18n:{ months:['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre',  ] } }">
                                  <span class="input-group-btn">
                                  <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                                  </span>
                                        </div>
                    ...
                    <!-- END FORM-->
                          ...
                          <div class="form-actions">
                            <input type="submit" name="" value="Crear Expediente" class="btn blue">
