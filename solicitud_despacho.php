        ...
        <div id="page-content">
          ...
          <div class="row">
            ...
            <div class="col-md-10">
              ...
              <div class="col-md-6">
                <?php if ($base == "esa") { //Valido para que solo el usuario del el el salvador puedan ver el boton ?>
                  <div class="col-md-6">
                    <a href="solicitudes_elsalvador.php">
                      <button type="button" class="btn btn-danger">VER SOLICITUDES SV</button>
                    </a>
                  </div>
                <?php } ?>
                      ...
                      <div class="skin skin-minimal">
                        ...
                        <div class="portlet light bordered">
                            ...
                            <form method="post" action="solicitud_pdf.php" enctype="multipart/form-data">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <select id="inputState" class="form-control" name="proveedor" required="required">
                                  ...
                                  <option value="TRANSPORTE VANEGAS">TRANSPORTE VANEGAS</option>
                                </select>
                              </div>
                              <div class="form-group col-md-6">
                                <b>FLETE</b>
                                <input type="text" class="form-control" name="flete" value="0" id="inputEmail4"
                                  placeholder="INGRESE COSTO DE FLETE" required="required">
                              </div>
                              <div class="form-group col-md-6">
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="cancelacion" value="0" id="inputPassword4"
                              placeholder="INGRESE COSTO DE SINI" required="required">
                          </div>
                          <div class="form-group col-md-6">
                            <b>IMPUESTOS</b>
                            <input type="text" class="form-control" name="impuestos" value="0" id="inputPassword4"
                              placeholder="INGRESE COSTO IMPUESTOS" required="required">
                          </div>
                          ...
                          <div class="form-group col-md-6">
                            <b>CAPACIDAD VEHICULO</b>
                            <input type="text" class="form-control" name="capacidad" value="0" id="inputPassword4"
                              placeholder="INGRESE COSTO DE ENTREGA ADICIONAL" required="required">
                          </div>
                          <div class="form-group col-md-6">
                            <b>FLETE INCLUYE: </b>
