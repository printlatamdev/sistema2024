...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <nav class="menu-navigation-dark">
     <a href="fotoprueba_nc.php?id=<?php echo $id; ?>"><i class="fa fa-camera-retro"></i><span>Fotos Cargando</span></a>
    <a href="fotoprueba2_nc.php?id=<?php echo base64_encode($id); ?>"><i class="fa fa-camera-retro"></i><span>Fotos evento</span></a>
    <a href="fotoprueba3_nc.php?id=<?php echo base64_encode($id); ?>"> <i class="fa fa-camera-retro"></i><span>Fotos Entrega</span></a>
