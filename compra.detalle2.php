...
<head>
  ...
  <?php
  if ($pruebaget !== null && trim($pruebaget) == false) {
  } else {
    ?>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <div class="col-md-10">
        ...
        <div id="contenedor3" class="portlet box blue">
          <div class="portlet-title">
            <div class="caption">
              <i class=" icon-book-open font-green-sunglo"></i> Orden Compra # <label
                id="orden_color"><?= $compra ?></label>&nbsp;&nbsp;&nbsp;
              ...
              <div class="form-body">
                <div class="row">
                  <div class="col-md-10">
                    <div class="form-group">
                      <div class="col-md-5">
                        <label class="control-label"><strong>Proveedor:</strong></label>&nbsp;&nbsp; <label
                          class="label1" id="cliente_color"><?= $empresa ?></label>
                      </div>
                      <div class="col-md-5">
                        <label class="control-label"><strong>Solicita:</strong></label>&nbsp;&nbsp;<label class="label1"
                          id="vendedor_color"><?= $solicita ?></label>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-10">
                    ...
                    <div class="form-group">
                      <div class="col-md-5">
                        <label class="control-label "><strong>Fecha:</strong></label>&nbsp;&nbsp;<label class="label1"
                          id="fecha_color"><?= $fecha ?></label>
                      </div>
                      <div class="col-md-5">
                        <label class="control-label"><strong>OP:</strong></label>&nbsp;&nbsp;<label class="label1"
                          id="vendedor_color"><?= $op ?></label>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div id="contenedor2" class="portlet light bordered">
          ...
          <div class="portlet-body form">
            ...
            <div class="form-body">
              ...
              <form id="form1" action="compra.sql.php" method="post" role="form">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input value="<?= $cantidad ?>" required size="2" type="number" name="cantidad" id="cantidad" step="any"
                  min="0" placeholder="Cantidad" required>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                <input value="<?= $precio_unitario ?>" required size="2" type="number" name="precio_unitario"
                  id="precio_unitario" step="any" min="0" placeholder="Precio"
                  required>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <tr>
                      <td>
                        <form class="generar" name="form6" action="reportes/compra.pdf.php" target="_self" method="post">
                          ...
                          <button id="genera_con_iva" name="genera" type="submit" class="btn btn-danger btn-sm">
                            Generar Orden
                          </button>
                        </form>
                      </td>
                      ...
                      <td>
                        <form class="generar" name="form6" action="reportes/compra.pdf.php" target="_self" method="post">
                          ...
                          <button id="genera_sin_iva" name="genera" type="submit" class="btn btn-success btn-sm">
                            Generar Orden Sin IVA
                          </button>
                        </form>
                      </td>
                      ...
                      <td>
                        <div class="mok">
                          <form class="generar2" name="form9" action="reportes/compra.imprimir.php" target="_blank"
                            method="post">
                            <input type="hidden" id="id" name="id" value="<?= $compra ?>" />
                    ...
                    <tr>
                      <td>
                        <form class="generar" name="form6" action="compra.pdf.php" target="_self" method="post">
                          ...
                          <input type="checkbox" id="contactChoice1" name="ir" value="ir"><label
                            for="contactChoice1"><b>IR</b></label>
                          <button id="genera" name="genera" type="submit" class="btn btn-danger btn-sm">Generar Orden
                            Dolares</button>
                        </form>
                      </td>
                      ...
                      <td>
                        <form class="generar" name="form6" action="compra.pdf.php" target="_self" method="post">
                          ...
                          <input type="hidden" id="moneda" name="moneda" value="dollar" />
                          <input type="hidden" id="iva" name="iva" value="0" />
                          <input type="checkbox" id="contactChoice2" name="ir" value="ir"><label
                            for="contactChoice2"><b>IR</b></label>
                          <button id="genera" name="genera" type="submit" class="btn btn-success btn-sm">Dolares Sin
                            IVA</button>
                        </form>
                      </td>
                    ...
                    <tr>
                      <td>
                        <form class="generar" name="form6" action="compra.pdf.php" target="_self" method="post">
                          ...
                          <input type="hidden" id="iva" name="iva" value="15" />
                          <input type="checkbox" id="contactChoice3" name="ir" value="ir"><label
                            for="contactChoice3"><b>IR</b></label>
                          <button id="genera" name="genera" type="submit" class="btn btn-danger btn-sm">Generar Orden
                            Cordobas</button>
                        </form>
                      </td>
                      ...
                      <td>
                        <form class="generar" name="form6" action="compra.pdf.php" target="_self" method="post">
                          ...
                          <input type="hidden" id="moneda" name="moneda" value="cordoba" />
                          <input type="hidden" id="iva" name="iva" value="0" />
                          <input type="checkbox" id="contactChoice4" name="ir" value="ir"><label
                            for="contactChoice4"><b>IR</b></label>
                          <button id="genera" name="genera" type="submit" class="btn btn-success btn-sm">Cordobas Sin
                            IVA</button>
                        </form>
                      </td>
              ...
              if ($rowcount <= 0) {
                ...
                <small>
                  <strong>
                    Advertencia:
                  </strong> No podra ingresar mas de 9 item
                </small>
                ...
                <table width="60%" border="1" cellpadding="15">
                  ...
                  while ($fila_en = $cd->fetch_assoc()) {
                    ...
                    echo ' <tr>
                    <td align="center">
                    <a class="delete" href="compra.sql.php?bandera=3&det=' . $idc . '&compra=' . $compra . '" >
                    <img id="ex2" src="images/eli.png" alt="Eliminar Registro" />
                    </a>
                    </td><td align="left">&nbsp;&nbsp;' . $mat . '</td><td align="center">' . $cat . '</td><td align="center">$' . $pre . '</td><td align="right"> $' . $costo_total . '&nbsp;</td></tr>';
                  }
              ...
              <div id="fms0" class="col-md-12">
                ...
                <div id="fms" class="col-md-10">
                  ...
                  <form id="fomr1" method="post" action="compra.sql.php" class="form-horizontal"
                    ...
                    <div class="input">
                      <textarea rows="8" cols="80" name="mensaje">
      Buen dia Srita.
      
      Adjunto orde de compra para la adquisicion de X productos, para ser usados en X tareas, 
      favor compartir con Lic. Eduardo para su aprobacion y firma. 
      ...
      Saludos Cordiales.
                    ...
                    <div id='message' style='font-size:10px'>Presione <strong>>>Generar Orden<< </strong> o
                          <strong> >>Generar Orden sin IVA<< </strong> para habilitar esta opcion</div>
                    <div class="input"><input type="submit" id="sent" name="eviar" value="Enviar Correo"
                        class="btn yellow"></div>

                    <script type="text/javascript">
                      $("#sent").prop("disabled", true);
                      
                      // Deshabilitar el botón de enviar correo cuando se añade un material
                      $("#AddMaterial").click(function () {
                          $("#sent").prop("disabled", true);
                      });

                      // Habilitar el botón de enviar correo cuando se genera una orden (con IVA o sin IVA)
                      $("#genera_con_iva, #genera_sin_iva").click(function () {
                          $("#message").hide();
                ...
                <div class="row">
                  <div class="col-md-9">
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <select id="material_tipo" name="material_tipo" class="select2_category form-control"
                          tabindex="1">
