...
if (!isset($_GET['buscar']) or empty($_GET['buscar'])){
  ...
  $consulta = mysqli_query($conexion,"  select DISTINCT t1.id_orden, t2.id_orden,t2.id_empresa, t3.id_orden, t3.cot from logitica t1 INNER JOIN pop t2 on t1.id_orden= t2.id_orden INNER JOIN pop_detalle t3 on t2.id_orden=t3.id_orden where t2.id_empresa='".$id."'   order by t1.id_orden desc
 ");
