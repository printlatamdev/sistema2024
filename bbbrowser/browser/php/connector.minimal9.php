...
if($nivel==1 || $nivel==2 || $nivel==5 || $nivel==3 || $nivel==15 || $nivel==4 ){

	if ($tipo=="campos2" && $nivel==5 || $nivel==15 || $nivel==4) {


			
			$pte='../../ORDENES_OP/CAMPOS/'.$campo.'/EDITABLE';
			$pti='../../ORDENES_OP/CAMPOS/'.$campo.'/IMPRESION';
	...
	elseif($tipo=="campos2" && $nivel==3){
		$ptf='../../ORDENES_OP/CAMPOS/'.$campo.'/IMPRESION';
	}
