...
if($nivel==1 || $nivel==2 || $nivel==5 || $nivel==3 || $nivel==4|| $nivel==10 ){

	if ($tipo=="campos" && $nivel==5 || $nivel==4) {


			
			$pte='../../ORDENES_OP/COLOR/EL SALVADOR/'.$campo.'/EDITABLE';
			$pti='../../ORDENES_OP/COLOR/EL SALVADOR/'.$campo.'/IMPRESION';
	...
	elseif($tipo=="campos" && $nivel==3 || $nivel==10){
		$ptf='../../ORDENES_OP/COLOR/EL SALVADOR/'.$campo.'/FOTOS';
	}

	elseif($tipo=="campos" && $nivel==1 || $nivel==2){

		$pt1='../../ORDENES_OP/COLOR/EL SALVADOR/'.$campo;
	}
...
elseif($tipo=="original" && $nivel==1 || $nivel==2)
	{ 


	$pt2='../../Artes/'.$year.'/DISPLAYS/'.$empresa.'/'.$marca.'/'.$proyecto.'/DISENO';



     
     //$pt5='../../artes/'.$year.'/PRUEBA/'.$proyecto.'/ADMINISTRACION';


	//$pt7='../../artes/'.$year.'/PRUEBA/'.$proyecto.'/LOGISTICA';

	//$pt8='../../artes/'.$year.'/PRUEBA/'.$proyecto.'/REPORTE';
...
}elseif($nivel==3 || $nivel==9 || $nivel==10){
