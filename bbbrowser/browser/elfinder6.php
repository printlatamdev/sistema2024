...
<html>
	<head>
		...
		<script type="text/javascript" charset="utf-8">
			...
			$(document).ready(function() {
				$('#elfinder').elfinder({
					url : 'php/connector.minimal8.php?empresa=<?=$empresa?>&marca=<?=$marca?>&proyecto=<?=$proyecto?>&nivel=<?=$nivel?>&year=<?=$year?>&tipo=<?=$tipo?>',  // connector URL (REQUIRED)
				    lang: 'es',
				    height: '600px'
	...
	<body>
		...
		<!-- Element where elFinder will be created (REQUIRED) aquiii -->
