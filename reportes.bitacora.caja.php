...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- pegar codigo-->
    <!-- Items del Centro, para opciones-->
...
<h3>CAJA CHICA Verificar Logs!!</h3>
<table cellpadding="0" cellspacing="0" border="2" id="list">
              ...
              <?
                  ...
                  $listado=$mysqli->query("SELECT * FROM log_caja WHERE hora > '$tresmeses' ORDER BY 1 DESC");
...
<!--
    <script type="text/javascript" src="js/jqueryusuarios.js"></script>
    <script type="text/javascript" language="javascript" src="js/funcioneslogs.js"></script>
    <link type="text/css" href="css/demo_tableusuarios.css" rel="stylesheet" />
    <script type="text/javascript" language="javascript" src="js/jqueryusuarios.dataTables.js"></script> -->
 
 <script language="javascript">
function cambiacolor_over(celda){ celda.style.backgroundColor="#AEACAC" } 
function cambiacolor_out(celda){ celda.style.backgroundColor="#FFFFFF"}
    ...
    function doSearch()
    {
      var tableReg = document.getElementById('list');
