...
<br><br><br>
  <div class="row">
    <div class="col-md-1"></div>
        <a target="_self"  href="suministros.ingreso.nuevo.tinta.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            ...
            <a target="_self" class="more" href="suministros.ingreso.nuevo.tinta.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
        </a>
        <a target="_self"  href="suministros.ingreso.nuevo.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            <div class="visual">
              <i class="fas fa-fill-drip"></i>
            ...
            <a target="_self" class="more" href="suministros.ingreso.nuevo.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
        </a>
        <a target="_self"  href="suministros.ingreso.bodega.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            <div class="visual">
              <i class="fas fa-fill-drip"></i>
            ...
            <a target="_self" class="more" href="suministros.ingreso.bodega.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
  ...
  <div class="row">
    <div class="col-md-1"></div>
        <a target="_self"  href="suministros.precio.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            <div class="visual">
              <i class="fas fa-fill-drip"></i>
            ...
            <a target="_self" class="more" href="suministros.precio.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
        </a>
        <a target="_self"  href="suministros.salidas.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            <div class="visual">
              <i class="fas fa-fill-drip"></i>
            ...
            <a target="_self" class="more" href="suministros.salidas.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
        </a>
        <a target="_self"  href="suministros.descargas.bitacora.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            <div class="visual">
              <i class="fas fa-fill-drip"></i>
            ...
            <a target="_self" class="more" href="suministros.descargas.bitacora.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
  ...
  <div class="row">
    <div class="col-md-1"></div>
      <a target="_self"  href="suministros.descarga.tintas.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            <div class="visual">
              <i class="fas fa-fill-drip"></i>
            ...
            <a target="_self" class="more" href="suministros.descarga.tintas.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
