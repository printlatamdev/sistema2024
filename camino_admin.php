...
function myFunction(val) {
    var v =  val;
    window.open("documentos.php?id="+  v,  "toolbar=yes,scrollbars=yes,resizable=yes,top=125,left=600,width=650,height=550");
}

function myFunction2(val) {
    var v =  val;
    window.open("fotoprueba.php?id="+ v,  "toolbar=yes,scrollbars=yes,resizable=yes,top=125,left=600,width=650,height=550");
