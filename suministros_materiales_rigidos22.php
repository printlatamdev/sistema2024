...
<!-- BEGIN PAGE CONTENT-->
      <div class="row">
        <div class="col-md-3"><p><b><font size="4px" ><a style="color: #000;" href="suministros.reporte.materiales.rigido.php">RIGIDOS</a></font></b>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <b><font size="3px" ><a style="color: #000;" href="#">Existencias 0</a></font></b></p>
          ...
          <?php
            ...
            $rs=$mysqli->query("SELECT DISTINCT material  FROM `material22` WHERE medicion='unidad'");
                        $flag=0;
                        ...
                        <div class="portlet-body">
                            ...
                            <tbody> ';
                             ...
                             if (isset($_REQUEST['flag'])) {
                                $rs2=$mysqli->query("SELECT *  FROM `material22` WHERE material='".$material."' AND cantidad='0'  AND estado='1'");
                             } else {
                                $rs2=$mysqli->query("SELECT *  FROM `material22` WHERE material='".$material."' AND cantidad NOT LIKE '0'  AND estado='1'");
                             }
