        ...
        if(mysqli_num_rows($sql) == 0){
          ...
          while($row = mysqli_fetch_assoc($sql)){
            ...
            echo '
              ...
              <td><a data-fancybox data-options='{"data-backdrop":"static", "type" : "iframe", "iframe" : {"preload" : false } }' href="logistica/edit_fotos_nica.php?id=<?echo $row['id_orden']; ?>" class="btn bg-success"><i class="fas fa-camera-retro"></i></a></td>
              <td>
                  <a data-fancybox data-options='{"data-backdrop":"static", "type" : "iframe", "iframe" : {"preload" : false } }' href="logistica/edit_nica.php?id=<?echo $row['id_orden']; ?>" class="btn bg-primary"><i class="far fa-edit"></i>EDITAR</a>
