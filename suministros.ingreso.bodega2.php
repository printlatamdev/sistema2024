                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9">
                                  <select id="proveedor" name="proveedor" class="select2_category form-control" tabindex="1" required>
                                    ...
                                    while ($fila = $rs->fetch_row()) {
                                      echo '<option value="' . $fila[0] . '_' . $fila[1] . '">' . strtoupper($fila[1]) . '</option>';
                                    }
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>
              <center>
                <h4><strong>La tinta se ha ingresado con exito.<strong></h4>
              </center>
            </p>
          </div>
          <div class="modal-footer">
