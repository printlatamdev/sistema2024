            ...
            <div class="row">
              ...
              <div class="col-md-8 col-sm-8 col-xs-8">
                <div class="tab-content">
                  ...
                  <!-- --------------------------------------------------------MODAL PARA CREAR NUEVO TIPO DE MATERIAL-------------------------------------------------------------------- -->
                  ...
                  <!-- **********************************************FORMULARIO PARA INGRESO DE NUEVO SUMINIISTRO********************************************** -->
                                ...
                                <div class="col-md-9">
                                  <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                      <button id="ingreso_materiales_nuevo" type="button" class="btn blue">Crear Nuevo Material</button>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-md-6">
