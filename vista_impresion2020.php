...
<div class="wrapper">
 ...
 t1 inner join pop_detalle t5 on t1.id_orden=t5.id_orden inner join pop t2 on t5.id_orden=t2.id_orden inner join contacto t3 on t2.id_contacto=t3.id_contacto inner JOIN pop_marca t4 on t1.id_marca=t4.id_marca where t1.estado=0 and t1.numorden_compra='".$num_compra."'  ");?>
  ...
  <div class="table-responsive" align="center">
      ...
      <hr />
<div style="margin-left: -900px; margin-top: -50px;" >   <a class="fancyOther" data-fancybox data-type="iframe" href="add_pop/index.html"> <input type=image src="icono/add.png"  width="60" height="60"></a>  Agregar Orden. </div>
      <?php
        ...
        if(mysqli_num_rows($sql) == 0){
          ...
          while($row = mysqli_fetch_assoc($sql)){
            ...
            echo '
              ...
              <td><a class="fancyOther" data-fancybox data-type="iframe" href="../sistema/iframe.elfinder.odactivas.php?idorden='.$idord.'"><i class="fas fa-folder-open"></i></a>  </td>
              <td>
