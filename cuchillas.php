...
<div class="wrapper">
     ...
     <div class="container col-xs-12 col-md-12 col-lg-12 col-xl-12" style="margin-left: 10px;">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
            <h2><b>Listado de Cuchillas</b></h2>
          </div>
            <div class="row">
              <?php if ($nivel != 17) { ?>
	               <div class="col-sm-6">
		             <a href="#addCatCuchillas" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Agregar Nueva Categoria</span></a>
		           </div>
		           <div class="col-sm-6">
		             <a href="#addCatCuchilla" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Agregar Nuevo Accesorio</span></a>
		           </div>
              <?php } ?>
            </div>
  ...
  <?phpphp include("html/agregar_cuchilla.php");?>
  <!--MODAL AGREGAR ACCESORIO-->
  <?phpphp include("html/agregar_accesorio.php");?>
  <!--MODAL PARA EDITAR-->
  <?phpphp include("html/modal_edit.php");?>
  <!--MODAL PARA DESCARGAR-->
  <?phpphp include("html/modal_descarga.php");?>
  <!--MODAL PARA ELIMINAR-->
  <?phpphp include("html/modal_delete.php");?>
  <!--JAVASCRIT DE REDIRECCIONAMIENTO-->
  <script src="js/script_cuchilla.js"></script>
