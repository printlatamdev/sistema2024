			...
			<?
				...
				//-----------------------------------------------------
                 ...
                 $detalle= str_replace($search, $replace, $subject);
				  ...
				  echo "<tr><td colspan='2' ><font size='2'>".$detalle."</font></td><td align='center' width='14%' ><font size='2'>".$cantidad."</font></td><td align='center'   ><font size='2'>Q".$precio."</font></td><td width='13%' align='center'><font size='2'><strong>Q".number_format($costo_total, 2, '.', ',')."</strong></font></td></tr> ";
                      ...
                      <tr>
                       ...
                       <p>&nbsp;&nbsp;<?=$vendedor; ?></p>
                        <p>&nbsp;&nbsp;Atencion al Cliente &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Firma Cliente</p></td>
                                ...
                                <font size="2">  
                                 <strong>Q<?=number_format($sub_total, 2, '.', ','); ?></strong><br>
                                 <strong>Q<?=number_format($iva, 2, '.', ','); ?></strong><br>
                                 <strong>Q<?=number_format($total_oferta, 2, '.', ','); ?></strong><br>
                                 </font>
