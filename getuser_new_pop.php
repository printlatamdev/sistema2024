    ...
    <div class="modal-content">
      <form action="form/finalizar_item.php" method="POST">
        ...
        <div class="modal-body">
          <H5>
            <p>Desea terminar este item? <? //echo $id_pliego;
                                          ?></p>
          </H5>

          <input type="text" name="item" value="<? echo $id_item; ?>">
          <input type="text" name="si_orden" value="<? echo $id_orden; ?>">
          <input type="text" name="nivel" value="<? echo $nivel; ?>">
...
if ($arte == null) {
  ...
  $link_arte = '../sistema2024/ORDENES_POP/' . $carpeta_pais . '/' . $folderid . '/ARTES' . '/' . $arte;
}
...
<div id="<? echo $pliego ?>" class="col-md-12 collapse multi-collapse" style="margin-top:100px;">
  ...
  while ($row2 = mysqli_fetch_array($result2)) {
    ...
    if ($arte == null) {
      ...
      $link_arte2 = '../sistema2024/ORDENES_POP/' . $carpeta_pais . '/' . $folderid . '/ARTES'. '/' . $arte2;
    }
    ...
    <? $material25 = "SELECT * FROM material WHERE id = '" . $id_material . "'";

    $result21 = mysqli_query($con, $material25);
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="form/finalizar_item.php" method="POST">
          ...
          <div class="modal-body">          
            <H5><p>Desea terminar este pliego? <? //echo $id_pliego;
                                                ?></p></H5>
