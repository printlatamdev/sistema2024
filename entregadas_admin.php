...
a1.carta_p, a1.factura, a1.duca_t, a1.duca_f, a1.nota_envio_cd, a1.orden_compra, a1.nota_envio FROM logitica a1 inner join pop a2 on a1.id_orden=a2.id_orden inner join empresa a3 on a2.id_empresa=a3.id_empresa WHERE a1.estado=0 and a1.status='ENTREGADO'  order by a1.f_llegada desc
...
function myFunction(val) {
    var v =  val;
    window.open("pruebadoc_admin.php?id="+ v,  "toolbar=yes,scrollbars=yes,resizable=yes,top=125,left=600,width=650,height=550");
}
...
function myFunction4(val) {
    var v =  val;
    window.open("pruebadoc_nc_admin.php?id="+  v,  "toolbar=yes,scrollbars=yes,resizable=yes,top=125,left=600,width=650,height=550");
}
