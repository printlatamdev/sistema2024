...
if ($tipo == "c13") {
   ...
   if ($size == 'l') {
      ...
      //echo "http://$uri/cotizacion.pdf.normal13.php?id=$id&bss=" . $_SESSION['base'] . "&bs=" . $_SESSION['base'] . $anio . "&ano=" . $anio . "";
   ...
   if ($size == 'l') {
      // echo "http://$uri/cotizacion.pdf.larga7.php?id=$id&bss=" . $_SESSION['base'] . "&bs=" . $_SESSION['base'] . $anio . "&ano=" . $anio . "";
      ...
      // echo "http://$uri/cotizacion.pdf.normal7.php?id=$id&bss=" . $_SESSION['base'] . "&bs=" . $_SESSION['base'] . $anio . "&ano=" . $anio . "";
