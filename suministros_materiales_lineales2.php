      ...
      <div class="container col-xs-12 col-md-12 col-lg-12 col-xl-12" style="margin-left: 10px;">
        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <p><b>
            <font size="4px"><a style="color: #000;" href="suministros_materiales_lineales2.php">METROS LINEALES</a></font>
                <!-- <font size="4px"><a style="color: #000;" href="suministros.reporte.materiales.metros.php">METROS LINEALES</a></font> -->
              </b>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <b>
                <font size="3px"><a style="color: #000;" href="suministros_materiales_lineales2.php?flag=0">Existencias 0</a></font>
              </b>
            </p>
