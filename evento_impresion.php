...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <nav class="menu-navigation-dark">
    <a href="evento_impresionsv.php?id=<?php echo $id; ?>"><i class="fa fa-camera-retro"></i><span>Impresion</span></a>
    <a href="evento_cortesv.php?id=<?php echo base64_encode($id); ?>"><i class="fa fa-camera-retro"></i><span>Corte</span></a>
    <a href="evento_acabadosv.php?id=<?php echo base64_encode($id); ?>"> <i class="fa fa-camera-retro"></i><span>Acabados</span></a>
