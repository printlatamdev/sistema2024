...
if ($bandera == 1) {
  ...
  header("Location: compra.detalle2_copy.php?compra=" . $compra . "");
} elseif ($bandera == 2) {
  ...
  # VERICA CUANTAS LINEAS TIENE ACTUALMENTE
  ...
  # LINEAS PERMITIDAS MAS LA QUE VIENE, MAXIMO DE 9 LINEAS, SI NO DA ERROR
  if( ( $countRow + 1 ) <= 9 ){
...
//FALLA EN CORREO ELECTRONICO Y ORDEN DE COMPRA
// ENVIO DE CORREOS ELECTRONICOS
  ...
  //*****************************************************************************
  //ORDENES DE COMPRA EMAIL - LOCATION
  include("email/class.phpmailer.php");
  include("email/class.smtp.php");
  ...
  $mail->Host = "smtp.gmail.com";
  $mail->Port = 465;
  // $mail->Username = "it@printlatam.com";
  // $mail->Password = "pruebacolor123";

  $mail->Username = "it@printlatam.com";
  $mail->Password = "sm#rPVnA3GiTb"; //Ee8QHhhGA9P%6yW.
  ...
  // $mail->AddAddress("produccion@vyasal.com", "Sistemas");
  $mail->AddAddress("it@printlatam.com", "Test User");
  ...
  // DESABILITAMOS YA QUE NO ENMVIA CORREO LOCAL
  header("Location: compra.detalle2_copy.php?compra=" . $_REQUEST['orden'] . "&flag=1");
} elseif ($bandera == 7) {
