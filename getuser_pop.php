...
if ($arte==null) {
 $link_arte='imagenes/no_disponible.png';
  ...
  $link_arte='../sistema2024/ORDENES_POP/'.$carpeta_pais.'/'.$id_orden.'/ARTES_'.$id_orden.'/'.$arte;
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">NOTAS DE IMPRE</h4>
             </div>
            <div class="modal-body">
...
while($row2 = mysqli_fetch_array($result2)) {
     ...
     $findet='';
      ...
      if ($arte==null) {
        ...
        $link_arte2='../sistema2024/ORDENES_POP/'.$carpeta_pais.'/'.$id_orden.'/ARTES_'.$id_orden.'/'.$arte2.'';
      }
