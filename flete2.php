...
mysqli_select_db($con,''.$bd.'');
   $troquel = mysqli_query($con,"select*from troqueles");
...
<!--***************************************************************************************-->
  ...
  <link href="troquel/vendors/vectormap/jquery-jvectormap-2.0.2.css" rel="stylesheet" type="text/css"/>
  
  <!-- Custom Fonts -->
    <link href="troquel/dist/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    
  <!-- Data table CSS -->
  <link href="troquel/vendors/bower_components/datatables/media/css/jquery.dataTables.min.css" rel="stylesheet" type="text/css"/>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <?if($nivel!=50){?><img src="images/logo_color.png" alt="AdminLTE Logo" 
...
TROQUELES
      <table class="table display responsive product-overview mb-30" id="myTable">
                        ...
                        <tbody>
<?
                          while($row = mysqli_fetch_assoc($troquel)){
                              ?>
                          <tr>
                            <td class="txt-dark">#<?=$row['cod']?></td>
                            <td class="txt-dark"><?=$row['nombre']?></td>
                            
                            <td class="txt-dark"><?=$row['cat']?></td>
                            <td>
                              
                              <div id="fms3" class="col-md-6">   
                                    <center>
                                       <a href="f_troquel/<?=$row['foto']?>" target="_blank" data-fancybox="preview" data-width="70%" data-height="70%"><img width="70px"   src="f_troquel/<?=$row['foto']?>"></a>
                                    </center>
                            ...
                            <td><a href="javascript:void(0)" class="text-inverse pr-10" title="Edit" data-toggle="tooltip"><i class="zmdi zmdi-edit txt-grey"></i></a><a href="javascript:void(0)" class="text-inverse" title="Delete" data-toggle="tooltip"><i class="zmdi zmdi-delete txt-grey"></i></a></td>
                          </tr>
...
<!--**************************************************************************-->
  <script src="troquel/vendors/bower_components/jquery/dist/jquery.min.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="troquel/vendors/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
    
  <!-- Data table JavaScript -->
  <script src="troquel/vendors/bower_components/datatables/media/js/jquery.dataTables.min.js"></script>
  <script src="troquel/dist/js/productorders-data.js"></script>
  
  <!-- Slimscroll JavaScript -->
  <script src="troquel/dist/js/jquery.slimscroll.js"></script>
  
  <!-- Owl JavaScript -->
  <script src="troquel/vendors/bower_components/owl.carousel/dist/owl.carousel.min.js"></script>
  
  <!-- Switchery JavaScript -->
  <script src="troquel/vendors/bower_components/switchery/dist/switchery.min.js"></script>
    
  <!-- Fancy Dropdown JS -->
  <script src="troquel/dist/js/dropdown-bootstrap-extended.js"></script>
    
  <!-- Init JavaScript -->
  <script src="troquel/dist/js/init.js"></script>
<!--***************************************************************************-->
