...
$consulta2 = mysqli_query($conexion2,"  
...
a1.carta_p, a1.factura, a1.duca_t, a1.duca_f, a1.nota_envio_cd, a1.orden_compra, a1.nota_envio FROM logitica a1 inner join pop a2 on a1.id_orden=a2.id_orden inner join empresa a3 on a2.id_empresa=a3.id_empresa WHERE  a1.estado=1 and a1.status='PROCESO' OR a1.status='CARGANDO' OR a1.status='DESPACHO' order by a1.f_llegada asc
 ...
 ");
    ...
    $ordenes_proceso=$ordenessv+$ordenesni;
...
function myFunction(val) {
    var v =  val;
    window.open("documentos.php?id="+ v, "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=125,left=600,width=650,height=550");
}

function myFunction2(val) {
    var v =  val;
    window.open("fotoprueba.php?id="+ v, "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=125,left=600,width=650,height=550");
}
function myFunction4(val) {
    var v =  val;
    window.open("documentos_nc.php?id="+  v,  "toolbar=yes,scrollbars=yes,resizable=yes,top=125,left=600,width=650,height=550");
}

function myFunction5(val) {
    var v =  val;
    window.open("fotoprueba_nc.php?id="+ v,  "toolbar=yes,scrollbars=yes,resizable=yes,top=125,left=600,width=650,height=550");
}
</script>
...
<li><a href="proceso_admin.php"><i class="fas fa-dolly"></i> <span>ORDENES EN PROCESO</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        REGISTRO
        <small>ENVIOS COLOR DIGITAL EL SALVADOR </small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index_admin.php"><i class="fas fa-door-open"></i> PAGINA PRINCIPAL</a></li>
        ...
        <table class="dropdown notifications-menu">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td align='center'><a href='pruebadoc_nc.php?nombre=<?echo $nombre;?>' role='button' ><i class='far fa-file'></i></a></td>
