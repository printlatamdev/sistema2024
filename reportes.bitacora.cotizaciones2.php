...
<div style="position: absolute; margin-left: 340px; margin-top: 4px;z-index: 1">
  <form>
...
<h3>COTIZACIONES Verificar Logs!!</h3>
<table cellpadding="0" cellspacing="0" border="2" id="list">
              ...
              <?
                  ...
                  $listado=$mysqli->query("SELECT * FROM log_cotizacion WHERE hora > '$tresmeses' ORDER BY 1 DESC");
