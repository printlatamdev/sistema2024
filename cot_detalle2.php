...
if (isset($_REQUEST["orden"])) {
   ...
   $rs_en=$mysqli->query("SELECT * FROM cotizacion WHERE id_cotizacion='".$orden."'");
     while ($fila_en = $rs_en->fetch_assoc()) {  $empresa = $fila_en["empresa"]; $contacto = $fila_en["contacto"]; $vendedor = $fila_en["vendedor"]; $fecha = $fila_en["fecha"]; $id_vendedor = $fila_en["id_vendedor"];$id_contacto = $fila_en["id_contacto"]; $id_empresa = $fila_en["id_empresa"]; }
              ...
              <div  id="contenedor3" class="portlet box blue">
                <div class="portlet-title">
                  <div class="caption">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <a data-toggle="modal" data-target="#ModalSubir"><font color="white">Editar Cabecera</font></a>
                  </div>
            ...
            <div class="portlet-title">
              ...
              <input value="<?=$precio_unitario?>" required size="2" type="number" name="precio_unitario" id="precio_unitario" step="any" min="0" placeholder="Precios">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <?
                             ...
                             if (isset($_REQUEST["det"])) {  echo '<button id="actualizar_detalle" type="button" class="btn blue">Actualizar</button>';

               } else {  echo '<button id="agregar_detalle" type="button" class="btn blue">Agregar</button>';          }
          ...
          <div id="details" class="portlet box blue">
            <div class="portlet-title">
              <div class="caption">
                <i class="fa fa-list-ul"></i>Detalles
                               ...
                               <div class="tools">
                                                ...
                                                <button type = "submit" class="btn btn-danger btn-sm"> 13% IVA V1</button>
                                                </form>
                                                ...
                                                <button type = "submit" class="btn btn-danger btn-sm"> 13% IVA V2</button>
                                                </form>
               ...
               <div class="tools">
                                ...
                                <input type="hidden" name="size" value="n" />
                                <button type = "submit" class="btn btn-info btn-sm"> 15% IVA V1 </button>
                                </form>
                ...
                <? if ($_SESSION['base']=='esa') {  ?>
                               ...
                               <div class="tools">
                                ...
                                <input type="hidden" name="size" value="n" />
                                <button type = "submit" class="btn btn-success btn-sm"> 12% IVA V1 </button>
                                </form>
                                ...
                                <form class="generar" name="form6" action="pdf3.php" target="_blank" method="post" >
                                <input type="hidden" id="id" name="id" value="<?=$orden?>" />
                                <input type="hidden" name="tipo" value="c12q" />
                                <input type="hidden" name="size" value="n" />
                                <button type = "submit" class="btn btn-success btn-sm"> 12% IVA V1 Q$ </button>
                                </form>
                                ...
                                <input type="hidden" name="tipo" value="c12q" />
                                <input type="hidden" name="size" value="l" />
                                <button type = "submit" class="btn btn-success btn-sm"> 12% IVA V2 Q$</button>
                                </form>
             ...
             <div class="tools">
                                ...
                                <input type="hidden" name="size" value="n" />
                                <button type = "submit" class="btn btn-warning btn-sm"> 0% IVA V1 </button>
                                </form>
                 ...
                 if ($_SESSION['base']=='nica') {
                      ...
                      ?>
                           ...
                           <div class="tools">
                                ...
                                <input type="hidden" name="size" value="n" />
                                <button type = "submit" class="btn btn-danger btn-sm"> 15% IVA V1 C$</button>
                                </form>
                                ...
                                <input type="hidden" name="tipo" value="cs15" />
                                <input type="hidden" name="size" value="l" />
                                <button type = "submit" class="btn btn-danger btn-sm"> 15% IVA V2 C$</button>
                                </form>
             ...
             ?>
                  ...
                  <input type="hidden" name="size" value="n" />
                  <button type = "submit" class="btn btn-warning btn-sm"> 7% IVA V1 $ </button>
                  </form>
...
jQuery(document).ready(function() {    
  ...
  //*****************************************************         
          jQuery('#empresa').change(function(){
            ...
            jQuery.post("archivos_cot/produccion.contactos.php", {emp: jQuery('#empresa').val()}, 
