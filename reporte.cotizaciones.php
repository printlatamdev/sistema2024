...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="imagenes/persona.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
  ...
  <div class="content-wrapper">
     ...
     <div class="col-md-11 col-lg-11 col-xs-12 embed-responsive embed-responsive-16by9">
  <iframe class="embed-responsive-item" src="coti.buscar.ventas.gerente.php" allowfullscreen></iframe>
</div>
