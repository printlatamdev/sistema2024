...
include("session.php");
                     ...
                     $sq="SELECT  * FROM vendedores WHERE nombre='".$_SESSION['username']."' ";			 		 
					 $rq=$mysqli->query($sq);
...
<!-- ------------CONTENIDO-----------------------------------------------------------------------------------------------  -->
                   ...
                   <!-- BEGIN EXAMPLE TABLE PORTLET-->
					<div class="portlet box red-intense">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-edit"></i>Historial
							</div>
							<div class="tools"></div>
						...
						<div class="portlet-body">
                                    ...
                                    <br>
                                     ...
                                     <form id="fomr1" name='form1' method="post" action="reporte.facturacion.admin.php" >

                                      <div class="input-group">
                                         <b>Vendedor:</b>&nbsp; 
                                         
                                         <select id="vendedor" name="vendedor" required    tabindex="1">
                                         <option value="">Seleccionar</option>
                                           ...
                                           <b>Inicio:</b>&nbsp; <input name="inicio" type="date" required >   &nbsp;&nbsp;&nbsp;  <b>Fin:</b>&nbsp; <input name="fin" type="date" required >
                                     ...
                                     <?                 
                                        ...
                                        if (isset($_REQUEST['vendedor'])) {
                                            ...
                                            include ('suministros/connect.php');
                                            $sq="SELECT  nombre FROM vendedores WHERE id='".$_REQUEST['vendedor']."' ";			 		 
                                            $rq=$mysqli->query($sq);
                                            while($ro=$rq->fetch_assoc()){ $name=$ro['nombre'];  }


                                            $inicio=date("Y-m-d", strtotime($_REQUEST['inicio']));
                                            $fin=date("Y-m-d", strtotime($_REQUEST['fin']));                                            
                                            $sql2="SELECT  SUM(monto) as total FROM log_ventas_facturacion WHERE fecha between '".$inicio."' AND '".$fin."' AND id_vendedor='".$_REQUEST['vendedor']."' ";
                                            $rs2=$mysqli->query($sql2);
                                            while($ro2=$rs2->fetch_assoc()){ $total=$ro2['total'];  }
                                            ...
                                            $mysqli->close();   
                                             ...
                                             echo "<br><br><br><b>Vendedor:</b> ".$name."&nbsp;&nbsp;&nbsp; <b>Inicio:</b> ".date("d-m-Y", strtotime($_REQUEST['inicio']))."&nbsp;&nbsp;&nbsp; <b>Fin:</b> ".date("d-m-Y", strtotime($_REQUEST['fin'])) ;
                                            
                                             echo "<br><br><b>Total: $".number_format($total, 2, '.', ',')."</b>";
                ...
                <?                 
					...
					if (isset($_REQUEST['vendedor'])) {
                       ...
                       $sql="SELECT  * FROM log_ventas_facturacion WHERE fecha between '".$inicio."' AND '".$fin."' AND id_vendedor='".$_REQUEST['vendedor']."' ";	

					} else {
						
						$sql="SELECT  * FROM log_ventas_facturacion ORDER BY id_venta DESC LIMIT 50";	
					}
						 ...
						 while($row=$rs->fetch_assoc()){ 
									...
									if($i==0){$class="odd"; $i=1;}
										 ...
										 echo "		   
												...
												<td ><b>".date("d-m-Y", strtotime($row['fecha']))."<b></td>
