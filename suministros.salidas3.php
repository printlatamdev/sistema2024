                          ...
                          <div class="col-md-9">
                            <div class="form-group">
                              ...
                              <div class="col-md-9">
                                  ...
                                  <input name="orden" id="orden" type="text" class="form-control input-circle-right " required>
                                    </div>
                          ...
                          <div class="col-md-9">
                            <div class="form-group">
                              ...
                              <div class="col-md-9">
                                <div class="radio-list">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                  <label class="radio-inline">
                                  <input class="rad" type="radio" name="empresa" id="empresa" value="color" checked />
