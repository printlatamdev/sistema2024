   ...
   <!-- pegar aqui el contenido--> 
      ...
      <div class="table-wrapper">
        ...
        if ($nivel==1 || $nivel==2 || $nivel==3) {?>
          ...
          <div class="col-sm-6">
            <a data-fancybox data-options='{"type" : "iframe", "iframe" : {"preload" : false }}' href="formop2_campos.php" class="btn btn-success" ><i class="material-icons">&#xE147;</i> <span>Agregar Nueva Orden</span></a>
          </div>
