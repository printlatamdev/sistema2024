            ...
            <div class="col-md-12">
              ...
              <div class="portlet box green">
                <div class="portlet-title">
                  <div class="caption"><i class="fa fa-edit"></i> <?php if (isset($_REQUEST['material'])) {
                  ...
                  <table class="table table-striped table-bordered table-hover" id="sample_1">
                    ...
                    <tbody>
                      ...
                      if (isset($_REQUEST['material'])) {
                        ...
                        $sql = "SELECT  * FROM log_bodega WHERE material='" . base64_decode($_REQUEST['material']) . "' ORDER by hora DESC";
                      } else {
        ...
        <script>
          jQuery(document).ready(function() {
            ...
            jQuery("#material").change(function() {
              ...
              window.location.href = "suministros.descargas.bitacora2.php?material=" + nm;
