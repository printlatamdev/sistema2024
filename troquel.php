...
<head>
  ...
  <!-- Data table CSS -->
  <link href="troquel/vendors/bower_components/datatables/media/css/jquery.dataTables.min.css" rel="stylesheet"
    type="text/css" />
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index.php" class="brand-link">
        <?php if ($nivel != 50) { ?><img src="images/logo_color.png" alt="AdminLTE Logo" style="opacity: .8;margin-left:10%"
            width="150"><?php } ?>
                ...
                while ($row = mysqli_fetch_assoc($troquel)) {
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="col-md-6">
                        <center>
                          <a href="f_troquel/<?= $row['foto'] ?>" target="_blank" data-fancybox="preview" data-width="40%"
                            data-height="40%"><img width="40px" src="f_troquel/imagen.png"></a>
                        </center>
