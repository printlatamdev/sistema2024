...
$query = mysqli_query($con,"select distinct a.id_orden, a.id_empresa, a.empresa, a.contacto, a.fecha_orden, a.vendedor, a.destino, a.id_proyecto, a.nombre_proyecto, a.estado, a.computo, a.impresion, a.corte, b.id_orden, b.origen,b.status, c.id_proyecto, c.marca, c.nombre from logitica b inner join pop a on b.id_orden = a.id_orden inner join pop_proyecto c on a.id_proyecto=c.id_proyecto where a.computo='1' and a.id_orden LIKE '%".$query2."%' order by a.id_orden desc  LIMIT $offset,$per_page");
  ...
  $query = mysqli_query($con,"select distinct a.id_orden, a.id_empresa, a.empresa, a.contacto, a.fecha_orden, a.vendedor, a.destino, a.id_proyecto, a.nombre_proyecto, a.estado, a.computo, a.impresion, a.corte, b.id_orden, b.origen,b.status, c.id_proyecto, c.marca, c.nombre from logitica b inner join pop a on b.id_orden = a.id_orden inner join pop_proyecto c on a.id_proyecto=c.id_proyecto where a.estado = '1' and  a.id_orden LIKE '%".$query2."%'  order by a.id_orden desc  LIMIT $offset,$per_page");
}
...
?>
       ...
       <table class="display table table-bordered" >
        ...
        <tr>
                    ...
                    <th># OP</th>
                    <th>Fecha</th>
          <th class='text-left' width="50">Cot</th>
          ...
          <th>ETD</th>
                    ...
                    <th>Info</th>
                    <th>Data</th>
                    <?php if ($nivel==1 || $nivel==2 || $nivel==3 || $nivel==11): ?>
                       <th>Impresiones</th>
                    <?php endif ?>
        ...
        if(mysqli_num_rows($query) == 0){
          ...
          while($row = mysqli_fetch_assoc($query)){
            ...
            <tr style="font-size:85%;" >
              <td style="font-size:15px;"><b>'.$row['id_orden'].'</b></td>
               <td><b>'.$row['fecha_orden'].'</b></td>
...
while($row92 = mysqli_fetch_assoc($result)){
          ...
          //termina nuevo para cotizaciones
                    ...
                    <td><b> <a data-toggle="modal" data-target="#no">'.$cot.'</a></b></td>
...
';
                            ...
                            <td><b>'.$row['nombre_proyecto'].'</b></td>
                           
              <td><b>'.$row['origen'].'</b></td>
                            <td><b>'.$row['destino'].'</b></td>
                              <td><b>'.$row['f_salida'].'</b></td>
                            <td><b>'.$row['f_llegada'].'</b></td>';
                            $nivel=$_SESSION['nivel'];
          $base=$_SESSION['base'];
