...
<?php
  ...
  /* Connect To Database*/
require("conexion_ajax.php");
require("conexion_ajax_19.php");
...
$query = mysqli_query($con,"select distinct a.id_orden, a.id_empresa, a.empresa, a.id_contacto, a.contacto, a.fecha_orden, a.fecha_entrega, a.vendedor, a.estado, a.computo, a.impresion, b.id_orden from orden a inner join orden_detalle b on a.id_orden=b.id_orden where a.computo='1' and a.id_orden LIKE '%".$query2."%'  order by a.id_orden desc  LIMIT $offset,$per_page");
  ...
  $query = mysqli_query($con,"select distinct a.id_orden, a.id_empresa, a.empresa, a.id_contacto, a.contacto, a.fecha_orden, a.fecha_entrega, a.vendedor, a.estado, a.computo, a.impresion, b.id_orden from orden a inner join orden_detalle b on a.id_orden=b.id_orden where a.estado='1' and a.id_orden LIKE '%".$query2."%'  order by a.id_orden desc  LIMIT $offset,$per_page");
    $numrows = mysqli_num_rows($query);
        ...
        if(mysqli_num_rows($query) == 0){
          ...
          while($row = mysqli_fetch_assoc($query)){
            ...
            <tr style="font-size:85%;" >
              <td ><b><h5>'.$row['id_orden'].'</b></h5></td>
              <td><b><h5>'.$row['fecha_orden'].'</b></h5></td>';
...
if ($encontrado==0) {
  $query233 = mysqli_query($con,"select*from cotizacion where id_cotizacion='".$cot."'");
             ...
             echo'<div class="col-md-12"><b><h5><a href="cotizaciones_'.$base.'20/'.$cot_d.'" data-fancybox="preview"><span class="label label-info">'.$cot.'</span></a></div>';
                            }
}else{
...
$sql="select*from cotizacion where id_cotizacion=610 ";
...
while($row92 = mysqli_fetch_assoc($result)){
        ...
        //termina nuevo para cotizaciones
                ...
                echo '
                   ...
                   <td> <b><h5><a data-toggle="modal" data-target="#no">'.$row['cot'].'</a></b></h5></td>
                ';
        ...
        if ($nivel==1 || $nivel==2 || $nivel==3 || $nivel==9) {
              ...
              <td><b><h5> '.$row['empresa'].'</b></h5> </td>
              <td><b><h5><a class="btn bg-success fas fa-arrow-alt-circle-down" data-toggle="collapse" data-target='.$documentos.' aria-expanded="false" aria-controls='.$documentos2.' ></a></b></h5</td>';?>
...
function <?echo $n_funcion;?>(str) {
  ...
  xmlhttp.open("GET","getuser_op2.php?q="+str,true);
  xmlhttp.send();
}
</script>
...
<div id="no" class="modal fade">
    ...
    <tr >
          <td colspan="16"  class="zeroPadding" >
            <div class="col" >
            <div class="collapse multi-collapse" id="<? echo $dataa2; ?>" style="width:145%" >
