   ...
   <!-- pegar aqui el contenido-->    
      ...
      <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
            <h2>Ordenes <b>PO Terminadas</b></h2>
          </div>
...
<strong>La orden fue creada con exito!</strong>  
  ...
  ?>
  <!--CARGANDO LOS DATOS EN EL IFRAME-->
            
  <div class="contenedor-responsivo">
          <iframe class="iframe-responsivo" src="po_fin_iframe.php" gesture="media"  allow="encrypted-media" allowfullscreen ></iframe>
  </div>
      <style>
  ...
  <script src="script_po_fin.js"></script>
