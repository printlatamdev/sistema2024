...
if($action == 'ajax'){
  ...
  if ($nivel==5) {
    ...
    $count_query = mysqli_query($con,"select distinct a.id_orden, a.id_empresa, a.empresa, a.id_contacto, a.contacto, a.fecha_orden, a.fecha_entrega, a.vendedor, a.estado, a.computo, a.impresion, b.id_orden, b.cot from orden a inner join orden_detalle b on a.id_orden=b.id_orden where ".$area." order by a.id_orden desc");
...
//actualizando estado de impresion y computo
...
//finalizando ordenes automaticamente 
...
while($rowor = mysqli_fetch_assoc($queryorden)){
  ...
  if ($computovar == 0 && $imprevar == 0) {
     $queryorder = mysqli_query($con,"UPDATE orden set estado='0' where id_orden='".$idorder."'");
  }
}
 ...
 if (!empty($query2)) {
      $query = mysqli_query($con,"select distinct a.id_orden, a.id_empresa, a.empresa, a.id_contacto, a.contacto, a.fecha_orden, a.fecha_entrega, a.vendedor, a.estado, a.computo, a.impresion, b.id_orden from orden a inner join orden_detalle b on a.id_orden=b.id_orden where  ".$area." or a.id_orden LIKE '%".$query2."%' or a.empresa LIKE '%".$query2."%' order by a.id_orden desc  LIMIT $offset,$per_page");
        $numrows = mysqli_num_rows($query);
      //loop through fetched data
    
  } else {
      $query = mysqli_query($con,"select distinct a.id_orden, a.id_empresa, a.empresa, a.id_contacto, a.contacto, a.fecha_orden, a.fecha_entrega, a.vendedor, a.estado, a.computo, a.impresion, b.id_orden, b.cot from orden a inner join orden_detalle b on a.id_orden=b.id_orden where  ".$area." order by a.id_orden desc");
  }
   
/*if ($nivel==5) {

  $query = mysqli_query($con,"select distinct a.id_orden, a.id_empresa, a.empresa, a.id_contacto, a.contacto, a.fecha_orden, a.fecha_entrega, a.vendedor, a.estado, a.computo, a.impresion, b.id_orden from orden a inner join orden_detalle b on a.id_orden=b.id_orden where a.impresion='1' or a.id_orden LIKE '%".$query2."%' or a.empresa LIKE '%".$query2."%' order by a.id_orden desc  LIMIT $offset,$per_page");
    $numrows = mysqli_num_rows($query);
  //loop through fetched data
}elseif($nivel==4){
$query = mysqli_query($con,"select distinct a.id_orden, a.id_empresa, a.empresa, a.id_contacto, a.contacto, a.fecha_orden, a.fecha_entrega, a.vendedor, a.estado, a.computo, a.impresion, b.id_orden from orden a inner join orden_detalle b on a.id_orden=b.id_orden where a.computo='1' and a.id_orden LIKE '%".$query2."%' or a.empresa LIKE '%".$query2."%'  order by a.id_orden desc  LIMIT $offset,$per_page");
  $numrows = mysqli_num_rows($query);
  ...
  $query = mysqli_query($con,"select distinct a.id_orden, a.id_empresa, a.empresa, a.id_contacto, a.contacto, a.fecha_orden, a.fecha_entrega, a.vendedor, a.estado, a.computo, a.impresion, b.id_orden from orden a inner join orden_detalle b on a.id_orden=b.id_orden where a.estado='1' and  a.empresa LIKE '%".$query2."%'  order by a.id_orden desc  LIMIT $offset,$per_page");
    $numrows = mysqli_num_rows($query);
}*/
...
?>
       ...
       <table class="table table-striped table-hover" id="example" class="table table-striped table-bordered" style="width:100%">
