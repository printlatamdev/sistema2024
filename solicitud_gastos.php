...
<link rel="shortcut icon" href="images/color.ico"/>
 ...
 <SCRIPT language=Javascript>
    ...
    <style>
        #div1, #div2, #div3 {background-color: #f4f4f4; margin: 5px; width: 50px; height: 0px;}
        #div2 {margin-top: 0px; margin-left: 60px; margin-bottom: 0px; !important}
    </style>
 ...
 <div id="page-content" >
      ...
      <div  class="row">
            ...
            <div class="col-md-10">
              <div class="col-md-6"></div>
                  	<div class="col-md-6"><div class="col-md-6"><a href="solicitudes_elsalvador.php"><button type="button" class="btn btn-danger" >VER SOLICITUDES SV</button></a></div>
                  	<div class="col-md-6"><a href="solicitudes_nicaragua.php"><button type="button" class="btn btn-danger">VER SOLICITUDES NI</button></a></div></div>
  ...
  <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      ...
      <input  type="text"   class="form-control" name="entrega" value="0" id="inputPassword4" placeholder="INGRESE COSTO DE ENTREGA ADICIONAL" required="required">
    </div>
  </div><div class="form-group col-md-6">
      <b>TRAMITE ADUANAL</b>
      <input  type="text"  class="form-control" name="aduanal" value="0" id="inputEmail4" placeholder="INGRESE COSTO DE TRAMITE ADUANAL" required="required">
    </div>
    <div class="form-group col-md-6">
      <b>CANCELACION DE SCANNER(SINI)</b>
      <input  type="text"  class="form-control" name="cancelacion" value="18" id="inputPassword4" placeholder="INGRESE COSTO DE SINI" required="required" readonly>
    </div>
    ...
    <div class="form-group col-md-6">
      ...
      <select id="inputState" class="form-control" name="transporte" required="required">
        <option value="">SELECCIONE ORDEN DE DESPACHO</option>
        <option value=""></option>
        <option value=""></option>
        <option value=""></option>
        <!--<option value="MARITIMO">MARITIMO</option>-->
    ...
    <div class="form-group col-md-6">
      <b>FLETE INCLUYE: </b>
      <input  type="text"   class="form-control" name="detalleflete" placeholder="INGRESE DETALLE"   required="required">
    </div>
