...
<br><br><br>
  <div class="row">
    <div class="col-md-1"></div>
        <a target="_self"  href="orden.comprass.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            ...
            <a target="_self" class="more" href="orden.comprass.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
        </a>
        <a target="_self"  href="compra.editar.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            <div class="visual">
              <i class="fas fa-fill-drip"></i>
            ...
            <a target="_self" class="more" href="compra.editar.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
        </a>
        <a target="_self"  href="compra.search.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            <div class="visual">
              <i class="fas fa-fill-drip"></i>
            ...
            <a target="_self" class="more" href="compra.search.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
  ...
  <div class="row">
    <div class="col-md-1"></div>
        <a target="_self"  href="compra.control.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            <div class="visual">
              <i class="fas fa-fill-drip"></i>
            ...
            <div class="details">
              ...
              <div class="desc">
                 REPORTES ORDEN DE COMPRA
              </div>
            </div>
            <a target="_self" class="more" href="compra.control.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
        </a>
        <a target="_self"  href="compra.documentacion.php">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <div class="dashboard-stat green-jungle">
            <div class="visual">
              <i class="fas fa-fill-drip"></i>
            ...
            <a target="_self" class="more" href="compra.documentacion.php">
            Ver Mas <i class="m-icon-swapright m-icon-white"></i>
            </a>
          </div>
        </div>
