  ...
  <div class="content-wrapper" style="">
     ...
     <div class="container">
        ...
        <div class="table-wrapper">
          ...
          <div class="col-sm-6">
            <a  class="btn btn-success" data-toggle="modal" data-target="#crearEmpleado"><i class="material-icons">&#xE147;</i> <span>Nuevo Expediente</span></a>
          </div>
                </div>
            </div>
...
<!-- Modal -->
<form method="post" action="expediente.sql.php" enctype="multipart/form-data">
    <div class="modal fade" id="crearEmpleado" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" m>
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header bg-success">
            <strong><h3>INGRESAR NUEVO EMPLEADO</h3></strong>
          ...
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col-md-3">
                <strong><span>Nombres: </span></strong>
              </div>
              <div class="col-md-9">
                <input type="text" class="form-control" name="nombres">
              </div><br><br><br>
              <div class="col-md-3">
                <strong><span>Apellidos: </span></strong>
              </div>
              <div class="col-md-9">
            ...
            <div class="row">
              <div class="col-md-6"><strong><span>Fecha de Ingreso: </span></strong></div>
              <div class="col-md-6"><strong><span>Vencimiento Periodo Prueba: </span></strong></div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <input type="date" class="form-control" id="datepicker" name="inicio">
              </div>
              <div class="col-md-2"></div>
              <div class="col-md-6">
                <input type="date" class="form-control" id="datepicker" name="prueba">
              </div>
...
<form>
	    ...
	    <div class="modal-dialog modal-lg" role="document">
	        <div class="modal-content">
	            ...
	            <div class="modal-footer clearfix">
	                ...
	                <div class="img-fluid col-md-6" alt="Responsive image">
	                  <img src="images/ready.png" style="height: 200px;width:200px;">
	                </div>
	                <div class="col-md-3"></div>
	            </div>
	        </div>
  ...
  <script src="js/script_expedientes.js"></script>
