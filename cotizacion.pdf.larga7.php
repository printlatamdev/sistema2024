...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
  ...
  <table width="100%" style="border:thin !important" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
    ...
    <tr>
      ...
      <td width="14%" align="center"><strong>
          <font size="1">PRECIO<br> UNITARIO</font>
        </strong></td>
      <td width="13%" align="center"><strong>
          <font size="1">COSTO<br> TOTAL</font>
        </strong></td>
    </tr>
    ...
    while ($row = $rs->fetch_assoc()) {
      ...
      echo "<tr><td colspan='2' ><font size='2'><br>" . $detalle . "</font><br><br></td>
  ...
  <table width="100%" style="border:thin !important" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
    <tr>
      <td style="border-top:hidden;" valign="top">
        <font size="-4"><br><strong>&nbsp;&nbsp;ACEPTACION DEL CLIENTE:</strong></font>
      </td>
    ...
    <tr>
      <td style="border-top:hidden;" valign="top">
        <font size="-4"><br><strong>&nbsp;&nbsp;OBSERVACI&Oacute;N:</strong></font>
      </td>
