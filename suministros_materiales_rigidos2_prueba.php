    ...
    <div class="content-wrapper">
      ...
      <div class="container col-xs-12 col-md-12 col-lg-12 col-xl-12" style="margin-left: 10px;">
        ...
        <div class="row">
          <div class="col-md-3">
            <p><b>
                <font size="4px"><a style="color: #000;" href="suministros.reporte.materiales.rigido.php">RIGIDOS</a></font>
              </b>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <b>
                <font size="3px"><a style="color: #000;" href="#">Existencias 0</a></font>
              </b>
            </p>
            <ul class="ver-inline-menu tabbable margin-bottom-10">
              ...
              $rs = $mysqli->query("SELECT DISTINCT material  FROM `material` WHERE medicion='unidad'");
              $flag = 0;
              while ($fila = $rs->fetch_row()) {
                ...
                echo '<li style="height:45px;">
                           ...
                           <img src="suministros/iconossuministros/caja.png" width="30px" height="30px"><strong>         ' . $material . '</strong></a>
                             </li>';
              }
            ...
            <div class="tab-content">
              ...
              while ($fila = $rs->fetch_row()) {
                ...
                if ($nivel == 4 or $nivel == 8 or $nivel == 1) {
                  ...
                  if ($material == 'Coroplast') {
                    echo headerCoroplast($flag, $material);
                  }elseif ($material == 'Poliestireno') {
                    echo headerPoliestireno($flag, $material);
                  }elseif ($material == 'Carton') {
                    echo headerCarton($flag, $material);
                  }elseif ($material == 'Foamboard') {
                    echo headerFoamboard($flag, $material);
                  }elseif ($material == 'PET') {
                    echo headerPET($flag, $material);
                  }elseif ($material == 'PVC') {
                    echo headerPVC($flag, $material);
                  }else{                  
                    echo headerGenaral($flag, $material);
                  } 
                  ...
                  if ($material == 'Coroplast') {
                    ...
                    # AQUI IRA LO QUE ESTABA ORIGINALMENTE
                    echo '                            
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="form-group">
                    Id Material<input id="id_sub" type="hidden" class="form-control" name="id_orden" aria-label="..." readonly="readonly" required>
                  </div>

                  <div class="form-group">
                    <input type="hidden" class="form-control" name="tipo" aria-label="..." value="rigido">
          ...
          <div class="modal fade" id="nota2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="form-group">
                    <input id="id_m" type="hidden" class="form-control" name="id_orden" aria-label="..." readonly="readonly" required>
                  </div>
                  <div align="center">
...
<?php
    ...
    function headerGenaral($flag, $material){
      return '         
        <div id="tab_' . $flag . '" class="tab-pane">
        <div id="accordion' . $flag . '" class="panel-group">
    ...
    function headerCoroplast($flag, $material){
      return '         
        <div id="tab_' . $flag . '" class="tab-pane">
        <div id="accordion' . $flag . '" class="panel-group">
    ...
    function headerPoliestireno($flag, $material){
      return '         
        <div id="tab_' . $flag . '" class="tab-pane">
        <div id="accordion' . $flag . '" class="panel-group">
    ...
    function headerCarton($flag, $material){
      return '         
        <div id="tab_' . $flag . '" class="tab-pane">
        <div id="accordion' . $flag . '" class="panel-group">
    ...
    function headerFoamboard($flag, $material){
      return '         
        <div id="tab_' . $flag . '" class="tab-pane">
        <div id="accordion' . $flag . '" class="panel-group">
    ...
    function headerPET($flag, $material){
      return '         
        <div id="tab_' . $flag . '" class="tab-pane">
        <div id="accordion' . $flag . '" class="panel-group">
    ...
    function headerPVC($flag, $material){
      return '         
        <div id="tab_' . $flag . '" class="tab-pane">
        <div id="accordion' . $flag . '" class="panel-group">
