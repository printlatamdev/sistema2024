...
<script src="js-picker/datapicker.js"></script>
...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="">
     ...
     <div class="container">
        ...
        <div class="col-sm-2">
            <a  class="btn btn-warning" data-toggle="modal" data-target="#modal-container"><i class="material-icons">&#xE147;</i> <span>Nuevo Contacto</span></a>
          </div>
          <div class="col-sm-3">
            <a  class="btn btn-success" data-toggle="modal" data-target="#myModal_autocomplete"><i class="material-icons">&#xE147;</i> <span>Nueva Empresa</span></a>
          </div>
          <div class="col-sm-3">
            <a  class="btn btn-info" data-toggle="modal" data-target="#myModal_proveedor"><i class="material-icons">&#xE147;</i> <span>Nuevo Proveedor</span></a>
          </div>
                        ...
                        <div class="row">
                            ...
                            <div class="Divider">
                                <div class="container-fluid">
                                    <strong><div class="Divider-text">Empresa</div></strong>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <select class="form-control selectpicker" id="empresa" name="empresa">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-10">
                                <div class="form-group">
                                  <div class="col-md-12">
                                    <input type="text" id="typeahead_example_2" name="contacto" class="form-control" placeholder="Nombre" required/>
                                    <p class="help-block">
                                       E.g: Alejandra Sanchez, Claudia Cornejo</code>
                                    </p>
                                  </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-10">
                                <div class="form-group">
                                  <div class="col-md-12">
                                    <input type="text" id="typeahead_example_3" name="tel" class="form-control" placeholder="Nombre" required/>
                                    <p class="help-block">
                                       E.g: 2236-7845, 2245-1278</code>
                                    </p>
                                  </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-10">
                                <div class="form-group">
                                  <div class="col-md-12">
                                    <input type="text" pattern="[0-9\-]+" id="typeahead_example_3" name="cel" class="form-control" placeholder="Nombre" required/>
                                    <p class="help-block">
                                       E.g: 7788-4563, 7645-1278</code>
                                    </p>
                                  </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-10">
                                <div class="form-group">
                                  <div class="col-md-12">
                                    <input type="text" id="typeahead_example_3" name="email" class="form-control" placeholder="Nombre" required />
                                    <p class="help-block">
                                       E.g: administrador@campospenate.com</code>
                                    </p>
                                  </div>
                                </div>
                            </div>
