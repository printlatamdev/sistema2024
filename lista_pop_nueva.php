...
<head>
  ...
  <script src="includes/js/jquery-ui-1.14.0/external/jquery/jquery.js"></script>
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index.php" class="brand-link">
        <? if ($nivel != 50) { ?><img src="images/logo_color.png" alt="CD" style="opacity: .9;margin-left:10%"
            width="170"><? } ?>
    ...
    <div class="content-wrapper">
      ...
      <div class="container col-xs-12 col-md-12 col-lg-12 col-xl-12" style="margin-left: 10px;">
          ...
          <div class="table-title">
            <div class="row">
              ...
              if ($base == "esa" || $base == "nica") {
                ...
                if ($nivel == 1 || $nivel == 2 || $nivel == 3 || $nivel == 17 || $nivel == 22) { ?>
                  <div class="col-sm-6">
                    <a data-fancybox data-options='{"type" : "iframe", "iframe" : {"preload" : false }}' href="form2.php"
        ...
        <div id='outer_div'></div><!-- Carga de datos ajax aqui -->
