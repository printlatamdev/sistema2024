...
<head>
  ...
  <?php
// Ensure $pruebaget is not null before using trim()
...
// If $pruebaget is null or an empty string, do nothing
?>
      ...
      <div class="container col-xs-12 col-md-12 col-lg-12 col-xl-12" style="margin-left: 10px;">
        ...
        <div class="table-wrapper">
          <div class="table-title">
            <div class="row">
              <div class="col-sm-6">
                <h2><b>Ordenes PO Campos Finalizadas</b></h2>
              </div>
        ...
        if (trim($exito) == false) {
          ...
          echo '<div class="alert alert-success" role="alert" style="width: 800px; height: 50px;">
        ...
        <script src="script_po_campos_fin.js"></script>
