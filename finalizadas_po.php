...
//echo $varccf;
        ...
        if ($nivel==1 || $nivel==2 || $nivel==3 || $nivel==50) { ?>
          ...
          <td>
            ...
            <? echo '<a href="form/nueva_pop/fin_pop.php?id='.$row['id_orden'].'" title="Finalizar" onclick="return confirm(\'Desea terminar esta orden?\')"class="delete"><i class="material-icons" data-toggle="tooltip" title="Eliminar">&#xE872;</i></a></td>';
              }else{?>
          <td>
          ...
          <td colspan="12" class="zeroPadding">
            <div class="col-md-12" >
                <div class="collapse multi-collapse" id="<? echo $documentos2;?>" style="width:100%" >
                  <div class="card card-body"><br>
                    <?include('form/admin_doc_fin.php');?>
                  </div>
                </div>
            </div>
          </td>
