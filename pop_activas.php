 ...
 <!-- IFRAME 
  <a  data-fancybox data-options='{"type" : "iframe", "iframe" : {"preload" : false }}' href="form2.php"><i class="far fa-edit"></i></a>-->
      ...
      <div style="margin-left: -700px;">
        ...
        <a  data-fancybox data-options='{"type" : "iframe", "iframe" : {"preload" : false }}' href="form2.php"> <input type=image src="icono/add.png"  width="60" height="60"></a>  Agregar Orden.</div><div style="margin-top: -50PX;"><h4>POP ORDENES ACTIVAS</h4></div>
        ...
        if(mysqli_num_rows($sql) == 0){
          ...
          while($row = mysqli_fetch_assoc($sql)){
            ...
            echo '
              ...
              <td>
                  <a data-fancybox data-options='{"data-backdrop":"static", "type" : "iframe", "iframe" : {"preload" : false } }' href="form3.php?id_orden=<?echo $row['id_orden']; ?>" class="btn bg-primary"><i class="far fa-edit"></i></a>
                 
                <? echo '<a href="form/nueva_pop/fin_pop.php?id='.$row['id_orden'].'" title="Finalizar" onclick="return confirm(\'Desea terminar esta orden?\')" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
              </td>
            </tr>
            <tr ><td colspan="15" class="zeroPadding" >
        <div class="col" >
    <div class="collapse multi-collapse" id='.$data2.' style="width:100%" >
      <div class="card card-body"><br>'.$data2.'';
