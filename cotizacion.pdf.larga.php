...
<?php
    if ($_REQUEST['bss']=='esa') { echo "p.c1 { background-image: url(images/logo_barra2.jpg); background-position:center; background:no-repeat;  }"; } 
    	else{ echo "p.c1 { background-image: url(images/logo_barra_nica2.jpg); background-position:center; background:no-repeat;  }";  }
?>
                    ...
                    <table  width="100%" style="border:thin !important" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000"  >
                     <tr>
                      ...
                      <tr>
                        ...
                        <td width="44%" style="border-left:thin;" ><font size="2">&nbsp;<?php echo $cliente; ?></font></td>
                      ...
                      <tr>
                        ...
                        <td style=" border-left:thin;" ><font size="2">&nbsp;<?php echo $contacto; ?></font></td>
                        <td colspan="3" rowspan="2"  align="center" ><font size="3"><b><?php echo $id."-".$ano; ?>&nbsp;</b></font></td>  
                      </tr>
                      ...
                      <tr>
                        ...
                        <td style="border-right:thin;"><font size="2">&nbsp;<?php echo $telefono; ?></font></td>
                      ...
                      <tr>
                        ...
                        <td style=" border-left:thin; border-right:thin;"><font size="2">&nbsp;<?php echo $email; ?></font></td>
                      
                        <td colspan="3" rowspan="3"><strong>Nota :</strong> <?php echo $nota; ?>&nbsp;</td>
                      </tr>
                      ...
                      <tr>
                       ...
                       <td style=" border-left:thin; border-right:thin;"><font size="2">&nbsp;<?php echo $ciudad; ?></font></td>
                      </tr>
                      ...
                      <tr>
                       ...
                       <p>&nbsp;&nbsp;<?php echo $vendedor; ?></p>
                        <p>&nbsp;&nbsp;Atencion al Cliente &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Firma Cliente</p></td>
                                ...
                                <font size="2">  
                                 <strong>$<?php echo number_format($sub_total, 2, '.', ','); ?></strong><br>
                                 <strong>$<?php echo number_format($iva, 2, '.', ','); ?></strong><br>
                                 <strong>$<?php echo number_format($total_oferta, 2, '.', ','); ?></strong><br>
                                 </font>
