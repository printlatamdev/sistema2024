...
{     
  ...
  if ($origen=='NI') {
    ...
    include("sol/connect2.php");
     ...
     $rs=$mysqli->query("select t1.id_orden, t1.id_empresa, t1.empresa, t1.id_proyecto, t2.id_proyecto, t1.estado, t2.nombre, t2.id_marca, t2.marca from pop where t1.id_orden='".$n_orden."' order by t1.id_orden desc");
...
$res21 = $mysqli->query("INSERT INTO solicitud_despacho(
  id_orden,n_orden,proveedor,flete,entrega_ad,tramite_adu,cancelacion,transporte,detalleflete,origen,destino,fecha) VALUES ('".$n_orden."','".$suma."','".$proveedor."','".$flete."','".$entrega."','".$aduanal."','".$cancelacion."','".$trans."', '".$detalleflete."','".$origen."','".$destino."','".$fecha."')");
...
$pdf->Cell(1,6,'',0,0,'L',1);
 $pdf->SetFont('Arial','',10);
$pdf->Cell(140,12,''.$detalleflete.'',1,0,'C',1);
// $pdf->SetFont('Arial','',10);
...
$pdf -> Cell(35,0,"f.__________________",0,200,"C");
$pdf -> Cell(140,0,"f.__________________",0,200,"C");
$pdf -> Cell(250,0,"f.__________________",0,200,"C");
...
$pdf -> Cell(35,0,"Solicita",0,200,"C");
$pdf -> Cell(140,0,"Claudia Martinez",0,200,"C");
$pdf -> Cell(250,0,"Nelson Aguiluz",0,200,"C");
$pdf -> Cell(360,0,"Lic. Eduardo Campos ",0,200,"C");
$pdf -> ln(3);
$pdf -> Cell(35,0,"Ruth Bonilla",0,200,"C");
...
$pdf->Ln(7);
    ...
    $pdf->Cell(25,10,$nuevo,1,0,'C',0);
       ...
       $pdf->Cell(50,10,$empresa,1,0,'C',0);
        $pdf->Cell(50,10,$proveedor,1,0,'C',0);
        $pdf->Cell(25,10,$capacidad,1,0,'C',0);
           $pdf->Cell(25,10,$origen,1,0,'C',0);
              $pdf->Cell(25,10,$destino,1,0,'C',0);
//Muestro la iamgen dentro de la celda GetX y GetY dan las coordenadas actuales de la fila
...
//Mostramos el documento pdf
$pdf->Output('F', 'logistica/solicitudes/'.$nuevo.'.pdf');
$pdf->Output();
