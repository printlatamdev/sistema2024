...
<div class="container">
  ...
  <form>
    <div class="form-row">
      ...
      <div class="form-group col-md-6">
        <label for="inputEmail4">PREDETERMINADO</label>
        <input type="text" class="form-control" name="promotor" value="PROMOTOR DE ADHERENCIA" id="inputEmail4" readonly="readonly">
      </div>
      <div class="form-group col-md-6">
        <label for="inputPassword4">#ORDEN</label>
        <input type="text" class="form-control" name="norden" id="inputPassword4">
      </div>
    </div>
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        <label for="inputCity">MATERIAL</label>
 ...
 <!-- SELECT
 <select class="form-control selectpicker" data-show-subtext="true" data-live-search="true" id="textqr" required>
