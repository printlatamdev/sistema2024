...
$id=$_SESSION['vsIdtemporal'];
 ...
 $obteniendo2 = mysqli_query($conexion,"select id_empresa, nombre from empresa where id_empresa='".$id."' ");
  $cliente = mysqli_query($conexion,"select id_empresa, nombre from empresa ");
   $marca = mysqli_query($conexion,"select id_marca, marca from pop_marca ");
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="portlet box green">
            <div class="portlet-title">
              <div class="caption"><i class="fa fa-edit"></i>Detalles Caja Chica 
            ...
            <div class="portlet-body">
                 <b>Fecha Inicio:</b> <font color="blue"> <?=$ini?>  </font> </br>
               <b>Fecha Fin:</b> <font color="blue"><?=$fin?></font> </br>
               <b>Saldo Inicial:</b> <font color="blue"> C$ <?=$saldo?></font> </br>
               <b>Saldo Transferido:</b> <font color="blue"> C$ <?=$tran?> </font>
        ...
        $rowcount=mysqli_num_rows($cd);
                  ...
                  while ($fila = $cd->fetch_assoc()) {  
                    ...
                    <td >
                      <? if ($recibo!="") { echo '<a href="caja_'.$_SESSION['base'].$_SESSION['year'].'/recibos/'.$recibo.'" target="_blank">Ver</a>';} ?>
                                        </td>

                                        <td > <? if ($comprobante!="") { echo '<a href="caja_'.$_SESSION['base'].$_SESSION['year'].'/recibos/'.$comprobante.'" target="_blank">Ver</a>';} ?></td>
...
<script src="suministros/assets/global/plugins/amcharts/amcharts/amcharts.js" type="text/javascript"></script>
<script src="suministros/assets/global/plugins/amcharts/amcharts/serial.js" type="text/javascript"></script>
<script src="suministros/assets/global/plugins/amcharts/amcharts/pie.js" type="text/javascript"></script>
<script src="suministros/assets/global/plugins/amcharts/amcharts/radar.js" type="text/javascript"></script>
<script src="suministros/assets/global/plugins/amcharts/amcharts/themes/light.js" type="text/javascript"></script>
<script src="suministros/assets/global/plugins/amcharts/amcharts/themes/patterns.js" type="text/javascript"></script>
<script src="suministros/assets/global/plugins/amcharts/amcharts/themes/chalk.js" type="text/javascript"></script>
<script src="suministros/assets/global/plugins/amcharts/ammap/ammap.js" type="text/javascript"></script>
<script src="suministros/assets/global/plugins/amcharts/ammap/maps/js/worldLow.js" type="text/javascript"></script>
<script src="suministros/assets/global/plugins/amcharts/amstockcharts/amstock.js" type="text/javascript"></script>
