      ...
      <div class="card mb-4 wow fadeIn">
        ...
        <div class="card-body d-sm-flex justify-content-between">
          ...
          <h4 class="mb-2 mb-sm-0 pt-1">
            <a href="https://mdbootstrap.com/docs/jquery/" target="_blank">Fotos</a>
            <span><? echo $evento     ?></span>
            <span></span>
          </h4>
       ...
       <table class="table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>  <figure class="col-md-4">
        
           <a href="../sistema/artes_esa17/<?php echo $row['foto']; ?>" data-size="1600x1067">
          <img alt="picture"  height='150px' src="../sistema/artes_esa17/<?php echo $row['foto']; ?>" class="img-fluid"> 
        </a>
      </figure> </td>
