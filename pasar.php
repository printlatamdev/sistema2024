...
//alert(dato);
OpenPage('pasar.php?textbox='+dato);
}
...
<script class="cssdeck" src="//cdnjs.cloudflare.com/ajax/libs/jquery/1.8.0/jquery.min.js"></script>
 ...
 Valor Pasado: <?php echo htmlentities($_GET['textbox']); ?>
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $row[   'destino'   ];  ?>  </td>
                             ...
                             <?php
                              ...
                              <? echo '  <tr id="tdc"  type="button" data-toggle="collapse" data-target="'.$data.'" aria-expanded="false">';  ?>
                              
                              <div id="loading" style="display:none;" align="left"></div>
                             <td> <input name="textbox" type="text" id="textbox" value="<?echo $row[   'marca'  ]; ?>" size="8" /></td>
