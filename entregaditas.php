...
<ul class="sidebar-menu" data-widget="tree">       
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">           
            <li class="treeview">
              <a href="#"><i class="fa fa-circle-o"></i> 2
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-circle-o"></i> 2.1</a></li>
                <li class="treeview">
                  <a href="#"><i class="fa fa-circle-o"></i> 2.2               
                  </a>                
            </li>           
          </ul>
        </li>       
...
while ($row25 = mysqli_fetch_array($consulta155))
     ...
     <!--aqui comienza el td de la tabla -->  <tr><td> <ul class="" data-widget="tree" id="select-beast">
       
          
        <li class="treeview">
     
            <i class="fas fa-print"></i><b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?echo $num_compra;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PALLET PRICESMART AGOSTO</b>
