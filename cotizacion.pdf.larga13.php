                    ...
                    <table  width="100%" style="border:thin !important" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000"  >
                     <tr>
                      ...
                      <tr>
                        ...
                        <td colspan="3" rowspan="2"  align="center" ><font size="3"><b><?=$id."-".date("y"); ?>&nbsp;</b></font></td>  
                      </tr>
			...
			<?
				...
				//-----------------------------------------------------
                 ...
                 $detalle= str_replace($search, $replace, $subject);
				  ...
				  echo "<tr><td colspan='2' ><br><font size='2'>".$detalle."</font><br><br></td><td align='center' width='14%' ><font size='2'>".$cantidad."</font></td><td align='center'   ><font size='2'>$".$precio."</font></td><td width='13%' align='center'><font size='2'><strong>$".number_format($costo_total, 2, '.', ',')."</strong></font></td></tr> ";
				    ...
				    $costo_total="";
                     ...
                     <tr>
                        <td style="border-top:hidden;" valign="top" ><font size="-4"><br><strong>&nbsp;&nbsp;ACEPTACION DEL CLIENTE:</strong></font></td>
                     ...
                     <tr>
                        <td style="border-top:hidden;" valign="top" ><br><font size="-4"><strong>&nbsp;&nbsp;OBSERVACI&Oacute;N:</strong></font><br><br></td>
