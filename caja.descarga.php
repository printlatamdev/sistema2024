            ...
            <div class="col-md-9">
              ...
              <div  id="contenedor1" class="portlet box blue">
                ...
                <div class="portlet-title">
                  <div class="caption">
                    <i class="icon-wallet"></i> Gastos - Saldo Disponible C$ <?php echo $saldo_actual?>
                  </div>
                          ...
                          <div class="col-md-10">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <input required   type="number" name="monto" id="monto" step="any" min="0" max="<?php echo $saldo_actual?>" class="form-control" placeholder="Cantidad" size="35px">
                                    </div>
      ...
      <?php
        ...
        if($rowcount<=0){ echo "";  }
                  ...
                  while ($fila = $cd->fetch_assoc()) {  
                    ...
                    ?>              
                    <tr align="center">
                    <td width="90px"><?php echo $fecha?></td>
                    <td align="left"><?php echo $concepto?></td>
                    <td>C$&nbsp;<?php echo number_format($monto, 2, '.', '')?></td>
                    <td>C$&nbsp;<?php echo number_format($disponible, 2, '.', '')?></td>
                    <td><?php echo $solicitante?></td>
                             
                    <td >

                                                                                
                        <div id="queue_cc<?php echo $p2?>"></div>
                        <div style="overflow:hidden">
                        <div style="float:left">
                          <p align="left"><input id="file_cc<?php echo $p2?>" name="file_cc<?=$p2?>" type="file"  ></p>
                        </div>
                        <div style="float:left; padding-left:20px"> 
                          <label id="message_cc<?php echo $p2?>" name="message_cc<?php echo $p2?>">   
                          <?php
                        ...
                        <script type="text/javascript">
                        var $cc<?php echo $p2?> = jQuery.noConflict();
                        $cc<?php echo $p2?>(function() {
                        $cc<?php echo $p2?>('#file_cc<?php echo $p2?>').uploadifive({
                          'uploadScript' : 'caja.sql.php',
                          'buttonText' : 'Subir',
                          'multi'    : false,
                          'removeCompleted' : true,
                          'method'   : 'post', 
                          'formData' : { 'bandera' : '5', 'id_gasto' : '<?php echo $id_gasto?>'  },
                          'onUploadComplete' : function(file, data, response) {  $cc<?php echo $p2?>('#message_cc<?php echo $p2?>').html(data);},
                          'height'   : 25,
                          'width'   : 45
                          ...
                          <div id="queue_ccf<?php echo $p?>"></div>
                          <div style="overflow:hidden">
                          <div style="float:left">
                            <p align="left"><input id="file_ccf<?php echo $p?>" name="file_ccf<?php echo $p?>" type="file"  ></p>
                          </div>
                          <div style="float:left; padding-left:20px"> 
                            <label id="message_ccf<?php echo $p?>" name="message_ccf<?php echo $p?>">   
                               <?php
                          ...
                          <script type="text/javascript">
                          var $ccf<?php echo $p?> = jQuery.noConflict();
                        $ccf<?php echo $p?>(function() {
                          $ccf<?php echo $p?>('#file_ccf<?php echo $p?>').uploadifive({
                            'uploadScript' : 'caja.sql.php',
                            'buttonText' : 'Subir',
                            'multi'    : false,
                            'removeCompleted' : true,
                            'method'   : 'post', 
                            'formData' : { 'bandera' : '4', 'id_gasto' : '<?php echo $id_gasto?>'  },
                            'onUploadComplete' : function(file, data, response) {  $ccf<?php echo $p?>('#message_ccf<?php echo $p?>').html(data);},
                            'height'   : 25,
                            'width'   : 45
