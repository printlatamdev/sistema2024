    ...
    <div class="content-wrapper">
      ...
      <div class="container">
        <div class="table-wrapper">
          ...
          <div style="position: absolute; margin-left: 180px; margin-top: 4px;z-index: 1">
            <form>
          ...
          <table cellpadding="0" cellspacing="0" border="2" id="list">
            <thead>
              <tr>
                <th>
                  <center>
                    <font size="4px">Detalle</font>
                  </center>
                </th>
                <th>
                  <center>
                    <font size="4px">Fecha y Hora</font>
                  </center>
                </th>
              </tr>
            </thead>
            ...
            <tbody>
              ...
              $listado = $mysqli->query("SELECT * FROM log_produccion  WHERE hora > '$tresmeses'  ORDER BY 1 DESC");
