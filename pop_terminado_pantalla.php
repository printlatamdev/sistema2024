...
a:active { color:#000000; text-decoration: underline; }
            ...
            <div class="page-content">
                <div class="secondary-sidebar">
                    <div class="secondary-sidebar-bar">
                        <a href="#" class="logo-box">COLOR DIGITAL</a>
                    </div>
                ...
                <div class="page-inner no-page-title">
                    <div id="main-wrapper">
                        <div class="content-header">
                            ...
                            <h1 class="page-title">ORDENES POP ACTIVAS</h1>
                        </div>
 ...
 <div id="loader"></div><!-- Carga de datos ajax aqui -->
      ...
      <div class='outer_div'></div><!-- Carga de datos ajax aqui -->
                            ...
                            <!-- Tab panes -->
                                    ...
                                    <div class="chat-list">
                                        ...
                                        <a href="javascript:void(0);" class="right-sidebar-toggle chat-item active-user" data-sidebar-id="chat-right-sidebar">
                                            <div class="user-avatar">
                                                <img src="pantalla_js/assets/images/avatars/avatar4.png" alt="">
                                            </div>
                                            <div class="chat-info">
        ...
        <script src="script_pantalla_pop_fin.js"></script>
