  ...
  <div class="content-wrapper">
    ...
    --><br>
       ...
       <td>ENVIOS TERMINADOS:<img height='30px' src="focus/ENTREGADO.png" /> </td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <form method="get" action="caminonew.php">
