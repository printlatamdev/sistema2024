                        ...
                        <div class="row">
                          <div class="col-md-10">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-5">
                                    <label class="control-label"><strong>Numero de Orden de Compra:</strong></label><br><br>
...
jQuery(document).ready(function() {    
   ...
   jQuery(document).on('click','.edit',function(){
                    ...
                    jQuery(window).attr('location','compra.detalle3.php?compra='+orden+'');
...
/*
           ...
           jQuery('#ord').on('keyup keypress', function(e) {
        ...
        if (keyCode === 13) { 
                      ...
                      var orden = jQuery("#ord").val();
                            ...
                            if(orden>150){
                              ...
                              jQuery(window).attr('location','cot.detalle.php?orden='+orden+'')

                    //jQuery("#page-content").load("coti.nueva.php?det=0&orden="+orden);
                    //jQuery('#page-content').fadeIn(1000);

                     }
                     else{

                      alert("NO SE PUEDEN EDITAR ORDENES ANTES DE LA 152");
                     }
                    return false;
