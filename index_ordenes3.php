...
<?php }else{ ?>
        ...
        <div class="row" style="margin-top: 100px;">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <a href="orden.comprass3.php">
              <div class="info-box-content">
               <h4> <span class="info-box-text">NUEVA O.C</span></h4>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            ...
            <a href="compra.editar3.php">
              <div class="info-box-content">
                <h4><span class="info-box-text">EDITAR O.C</span></h4>
  ...
  <?php endif ?>
       ...
       <a href="compra.search3.php">
              <div class="info-box-content">
               <h4> <span class="info-box-text">BUSCAR O.C</span></h4>
                <span class="info-box-number"></span>
              </div>
              <!-- /.info-box-content -->
            </div></a>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
             <span class="info-box-icon bg-warning elevation-1"><i class="fas fa-bookmark"></i></span>
                        <a href="compra.control3.php"> 

              <div class="info-box-content">
               <h4> <span class="info-box-text">REPORTES O.C</span></h4>
                <span class="info-box-number"></span>
              </div>
              <!-- /.info-box-content -->
            </div></a>
        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <a href="compra.documentacion3.php">
              <div class="info-box-content">
               <h4> <span class="info-box-text">DOCUMENTACION OC</span></h4>
                <span class="info-box-number">
