    ...
    <section id="main-content"  >
      <section class="wrapper"   >
       <div class="row" style="margin-top: 100px;">
          ...
          <?if ($base=="nica" && $nivel==3) {
            # code...
          }else{?>
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <span class="info-box-icon bg-info elevation-1"><i class="fas fa-fill-drip"></i></span>
              <a href="suministros.ingreso.nuevo.tinta3.php">
              <div class="info-box-content">
               <h4> <span class="info-box-text">CREAR TINTA</span></h4>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            ...
            <a href="suministros.ingreso.nuevo3.php">
              <div class="info-box-content">
                <h4><span class="info-box-text">CREAR MATERIAL</span></h4>
       ...
       <a href="suministros.ingreso.bodega3.php">
              <div class="info-box-content">
                <h4><span class="info-box-text">INGRESAR MATERIAL</span></h4>
                <span class="info-box-number"></span>
              </div>
              <!-- /.info-box-content -->
            </div></a>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
             <span class="info-box-icon bg-warning elevation-1"><i class="fas fa-bookmark"></i></span>
                        <a href="suministros.precio3.php"> 

              <div class="info-box-content">
              <h4>  <span class="info-box-text">PRECIOS MATERIAL</span></h4>
                <span class="info-box-number"></span>
              </div>
              <!-- /.info-box-content -->
            </div></a>
...
<!-- ******************************************************************************************************-->
      <div class="container-fluid">
        ...
        <div class="row" >
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <a href="suministros.salidas3.php">
              <div class="info-box-content">
               <h4> <span class="info-box-text">DESCARGA <br>MATERIAL</span></h4>
                <span class="info-box-number">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            ...
            <a href="suministros.descargas.bitacora3.php">
              <div class="info-box-content">
               <h4> <span class="info-box-text">BITACORA DESCARGA</span></h4>
                <span class="info-box-number"></span>
              </div>
              <!-- /.info-box-content -->
            </div></a>
       ...
       <a href="suministros.descarga.tintas3.php">
              <div class="info-box-content">
               <h4> <span class="info-box-text">FINALIZAR TINTA</span></h4>
                <span class="info-box-number"></span>
              </div>
              <!-- /.info-box-content -->
            </div></a>
